...
class salesByMonthExcelReport implements  ShouldAutoSize, FromCollection, WithHeadings, WithStyles
{
    private $data;
    ...
    public function collection()
    {
        ...
        $sheets[] = [
            'Total',
            number_format($this->total_items_sold,2),
