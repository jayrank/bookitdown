		...
		<form method="POST" id="saveConsultationForm" action="{{ route('saveConsultationFormDetails') }}">
			...
			<div class="my-custom-header">
				<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
					...
					<button class="btn btn-lg btn-primary next-step detailsFormBtn" onclick="nextPrev(1)" disabled type="button" id="submitConsultationFormBtn">Next Step</button>
				</div>
			</div>
						...
						<div class="row">
							<div class="col-12 col-md-2 p-0 border-right" style="height: calc(100vh - 90px);overflow-y: scroll;overflow-x: hidden;">
								<div class="">
									...
									<div class="card shadow-sm w-50 mx-auto mb-4 cursor-pointer"  data-toggle="modal" data-target="#addClientDetailModal" ondragstart="dragStartCustom(event)" draggable="true">
									...
									<div  class="card shadow-sm w-50 mx-auto mb-4 cursor-pointer" data-toggle="modal" data-target="#addCustomSectionModal" 
                                        ondragstart="dragStartCustom(event)" ondrag="draggingCustom(event)" draggable="true" id="dragDragCustom" >
										<div class="card-body px-4 py-6">
											<div class="mx-auto" style="height: 32px;width: 32px;">
												<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
							...
							<div class="col-12 col-md-10 bg-content"  style="height: calc(100vh - 90px);overflow-y: scroll;overflow-x: hidden;">
								...
								<div class="defaultView">
									<div class="card w-50 mx-auto my-6 checkClientSection" data-toggle="modal" data-target="#addNewSectionModal" ondrop="dragDrop(event)" ondragover="allowDropCustom(event)">
												...
												@foreach ($serviceData['service_price'] as $priceKey => $servicePrice)
													<li>
														<label for="all-{{ $serviceValue['category_title'] }}-{{ $serviceData['id'] }}-{{ $priceKey }}" class="checkbox">
															<input class="servicePriceIds" type="checkbox" name="value_checkbox[]" id="all-{{ $serviceValue['category_title'] }}-{{ $serviceData['id'] }}-{{ $priceKey }}" value="{{ $serviceData['id'] }}">
															<span></span>
