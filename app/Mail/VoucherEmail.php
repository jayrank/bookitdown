...
class VoucherEmail extends Mailable
{
     ...
     * @return void
     */
    public function __construct($FROM_EMAIL,$FROM_NAME,$SUBJECT,$MESSAGE,$VoucherSoldData,$LocationInfo,$ClientInfo,$RecipientFirstName,$RecipientLastName,$RecipientPersonalizedEmail)
	{
		...
		$this->recipient_personalized_email = $RecipientPersonalizedEmail;
	}
    ...
    public function build()
    {
        return $this->from($this->from_email,$this->from_name)
	                ->view('emailTemplates.purchasedVoucherMail')
