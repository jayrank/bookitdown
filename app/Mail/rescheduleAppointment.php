...
class newAppointment extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($this->from_email,$this->from_name)
	                ->view('emailTemplates.rescheduleAppointmentNotification')
                    ->with(['app' => $this->AppointmentServices,'client' => $this->client,'service' => $this->service,'appointment' => $this->appointment, 'remider' => $this->remidernoti,])
