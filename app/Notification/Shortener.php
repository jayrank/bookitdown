...
class Shortener extends Controller
{
    ...
    protected static $codeLength = 10;
	...
	{ 
		...
		$dbHost     = 'localhost';
		$dbUsername = 'uclf0lji6bka7';
		$dbPassword = 'ujsrnuzgqisx';
		$dbName     = 'dbqxyfppmadcjb';
    ...
    public static function urlToShortCode($url)
	{
        ...
        print_r(Shortener::validateUrlFormat($url));
        exit();
    ...
    protected function insertUrlInDB($url, $code){
        $query = "INSERT INTO ".self::$table." (is_generate_shortlink, long_url, short_code, created) VALUES (:is_generate_shortlink, :long_url, :short_code, :timestamp)";
        $stmnt = $this->pdo->prepare($query);
        $params = array(
            "is_generate_shortlink" => 2,
            "long_url" => $url,
            "short_code" => $code,
