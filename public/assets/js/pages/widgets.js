...
var KTWidgets = function() {
    ...
    var _initStatsWidget11 = function() {
        ...
        var options = {
            series: [{
                name: 'Sales',
                data: weekpr //[40, 40, 30, 30, 35, 35, 50]
            },
            {
                name: 'Appointments',
                data: appointment //[40, 40, 30, 30, 35, 35, 50]
            }],
            chart: {
                type: 'line',
                height: height,
            ...
            /*stroke: {
                ...
                show: true,
                width: 3,
                colors: [KTApp.getSettings()['colors']['theme']['base'][color], '#00f']
            },*/
            xaxis: {
                categories: weekdate, //['Feb', 'Mar', 'Apr', 'May', 'Jun', 'Aug', 'Sep'],
            },
            states: {
                normal: {
                    filter: {
            ...
            colors: [KTApp.getSettings()['colors']['theme']['light'][color], '#00f'],
            markers: {
                colors: [KTApp.getSettings()['colors']['theme']['light'][color], '#00f'],
                strokeColor: [KTApp.getSettings()['colors']['theme']['base'][color], '#00f'],
                strokeWidth: 3
            }
        };
    ...
    var _initStatsWidget12 = function() {
        ...
        var options = {
            series: [{
                name: 'Confirmed',
                data: confirmedAppointments //clientpr //
            },
            {
                name: 'Cancelled',
                data: cancelledAppointments //clientpr //
            }],
            chart: {
                type: 'bar',
                stacked: true,
            ...
            stroke: {
                ...
                show: true,
                width: 3,
                colors: [KTApp.getSettings()['colors']['theme']['base'][color], '#da2346']
            },
            xaxis: {
                categories: upcomingAppointmentsDate,//week, //
            },
            states: {
                normal: {
                    filter: {
            ...
            markers: {
                colors: [KTApp.getSettings()['colors']['theme']['base'][color], '#da2346'],
                strokeColor: [KTApp.getSettings()['colors']['theme']['base'][color], '#da2346'],
                strokeWidth: 3
            }
        };
