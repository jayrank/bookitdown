...
!(function (e, t) {
        ...
        "string" == typeof e &&
          (e =
            "#" === e.charAt(0) && -1 === e.indexOf(" ")
              ? se.querySelector(e)
              : se.querySelectorAll(e)),
        !e)
      )
        return !1;
      var te = i.Helpers;
      void 0 !== t.maxWidth &&
        (te.deprecated("maxWidth", "disableAt", "option"),
        ...
        n = function (e) {
          if (e.querySelector("ul") || "UL" === e.tagName) {
            ...
            var n,
              ...
              S = !1;
            ne.customToggle
              ? (d = te.getElements(ne.customToggle))
              : ((d = [
                  te.createElement(
                    "a",
                    { href: "#" },
            ...
            var M = function (e, t, n) {
              ...
              r = function (e) {
                var t = !!d && ie.getComputedStyle(d[0]).display,
                  n =
                    !!ne.disableAt && "max-width: " + (ne.disableAt - 1) + "px",
                  a = te.formatSizeVal(ne.width),
                  r = te.formatSizeVal(ne.height),
                  i = te.formatSizeVal(ne.levelSpacing);
                (te.isNumeric(a) || -1 !== a.indexOf("px")) &&
                  (y = parseInt(a)),
                  (te.isNumeric(r) || -1 !== r.indexOf("px")) &&
                    (A = parseInt(r)),
                  ...
                  -1 !== ["left", "right"].indexOf(ne.position)
                    ? l.add(
                  ...
                  (!e || (e && re("pushContent"))) &&
                    (p = ne.pushContent
                      ? te.getElements(ne.pushContent)[0]
                      : null),
                ...
                var s = L.classList.contains(ce),
                  o = [
                    ...
                    s ? ce : "",
                    ne.rtl ? "rtl" : "",
                    !0 !== ne.insertClose || ne.labelClose
                      ? ""
                ...
                L.removeEventListener("click"),
                  ...
                  se.documentElement.style.setProperty(
                    "--nav-level-spacing",
                    ne.levelSpacing + "px"
                  ),
                    ...
                    if ("UL" === e.tagName || e instanceof HTMLHeadingElement) {
                      ...
                      e instanceof HTMLHeadingElement
                        ...
                        : (null !== e.getAttribute("data-nav-active") &&
                            ((g = t), e.removeAttribute("data-nav-active")),
                          Array.prototype.forEach.call(
                            e.children,
                            function (e) {
                              var t =
                                  null !==
                                  e.getAttribute("data-nav-custom-content"),
                                n = t
                                  ? e.children
                              ...
                              if (!n.length) {
                                for (
                                  ...
                                  e.childNodes[o].nodeType === Node.TEXT_NODE &&
                                    (s += e.childNodes[o].textContent.trim());
                                n = [se.createTextNode(s)];
                              }
                              r.length &&
                                (te.data(e, "hc-uniqid")
                                  ? (i = te.data(e, "hc-uniqid"))
                                ...
                                l.items.push({
                                  ...
                                  highlight:
                                    null !==
                                    e.getAttribute("data-nav-highlight"),
                                });
                            }
                          )),
                        n.push(l);
                ...
                !(function h(n, e, m, g, t, a) {
                  ...
                  if (g && (0 === m || (0 < m && "overlap" === ne.levelOpen))) {
                    var i =
                      "string" == typeof g
                        ? g
                        : te.clone(
                            ie.jQuery && g instanceof ie.jQuery && g.length
                              ? g[0]
                              : g,
                            !0,
                            !0
                    ...
                    r.insertBefore(
                      ...
                      0 === m &&
                        "string" == typeof g &&
                        L.setAttribute("aria-labelledby", E + "-nav-title");
                  }
                  var s = -1;
                    ...
                    if ("UL" === e.tagName) {
                      ...
                      r.appendChild(p),
                        ...
                        e.items.forEach(function (t, e) {
                          ...
                          i
                            ? (r = te.clone(i, !1, !0)).classList.add(
                                "nav-item-link"
                              )
                            : (r = te.createElement(
                            ...
                            "#" === r.getAttribute("href") &&
                              r.addEventListener("click", te.preventDefault),
                            ne.closeOnClick &&
                              (F()
                                ? "A" !== r.tagName ||
                  ...
                  if (
                    ...
                    if (!0 === ne.insertBack || 0 === ne.insertBack) {
                      ...
                      r.insertBefore(
                        v,
                        te.children(r, ":not(.level-title)")[0]
                      );
                    } else {
                      var u = te.createElement(
                        "li",
                      ...
                      te.insertAt(
                        u,
                        !0 === ne.insertBack ? 0 : ne.insertBack,
                        o
                      );
                    }
                    var d = function () {
                    ...
                    te.wrap(
                      c,
                      te.createElement("div", { class: "nav-item-wrapper" })
                    ),
                  ...
                  if (0 === m && !1 !== ne.insertClose) {
                    var f = te.createElement(
                      "a",
                      {
                        ...
                        class:
                          "nav-close-button" +
                          (ne.labelClose ? " has-label" : ""),
                        role: "menuitem",
                        tabindex: 0,
                        "aria-label": ne.labelClose
                          ? ""
                          : (ne.ariaLabels || {}).close,
                      },
                    ...
                    if (
                      ...
                      r.insertBefore(
                        te.createElement("div", { class: "nav-close" }, f),
                        r.children[1]
                      );
                  ...
                  ("left" !== ne.position && "right" !== ne.position) ||
                    ...
                    "doc" === t
                      ? S ||
                        ...
                        se.addEventListener("touchend", U, te.supportsPassive))
                      : ((S = !0),
              ...
              q = function (e, t) {
                ie.addEventListener(
                  ...
                  p &&
                    ((p.style[te.browserPrefix("transition")] = "none"),
              ...
              H = function (e, t, n, a) {
                void 0 === t && (t = !0),
                  ...
                  p &&
                    ((p.style[te.browserPrefix("transition")] = ""),
              ...
              D = function (e) {
                ...
                (t =
                  ...
                  (("left" === ne.position && o < 50) ||
                    ("right" === ne.position &&
                      o > se.body.clientWidth - 50)) &&
                    ((w = !0), q(0 - (y - t), Math.abs(t)));
              },
              U = function e(t) {
                if (
                  (se.removeEventListener("touchmove", D),
              ...
              z = function (e) {
                ...
                if (!(Math.abs(t) < Math.abs(n))) {
                  var a =
                      "overlap" === ne.levelOpen ? G() * ne.levelSpacing : 0,
                    r = y + a;
                  (t =
                    "left" === ne.position
                      ? Math.min(Math.max(t, -r), 0)
                      : Math.min(Math.max(t, 0), r)),
                    (("left" === ne.position && t < 0) ||
                      ("right" === ne.position && 0 < t)) &&
                      ((w = !0), q(-Math.abs(t) + a, r - Math.abs(t)));
                }
              },
              I = function e(t) {
                if (
                  (v.removeEventListener("touchmove", z),
            ...
            r(),
              i(),
              _(),
              !0 === ne.removeOriginalNav
                ? e.parentNode.removeChild(e)
                : e.classList.add("hc-nav-original", E),
              "prepend" === ne.bodyInsert
                ? se.body.insertBefore(L, se.body.firstChild)
                : "append" === ne.bodyInsert && se.body.appendChild(L),
              !0 === ne.expanded && ((m = !0), $()),
              ne.swipeGestures &&
                (v.addEventListener("touchstart", B("nav"), te.supportsPassive),
                se.addEventListener(
                  "touchstart",
                  B("doc"),
                  te.supportsPassive
          ...
          function $(e, t) {
            if (
              ...
              ((function () {
                ...
                ne.disableBody &&
                  ((b =
                    ...
                    se.body.scrollTop),
                  se.documentElement.scrollHeight >
                    se.documentElement.clientHeight &&
                    oe.classList.add("hc-nav-yscroll"),
                ...
                L._eventListeners.toggle &&
                  L._eventListeners.toggle.forEach(function (e) {
                    e.fn(
                      te.customEventObject("toggle", L, L, { action: "open" }),
                      Object.assign({}, ne)
                    );
                  });
                setTimeout(function () {
              ...
              var n;
              if (
                ("number" != typeof e && !te.isNumeric(e)) ||
                ("number" != typeof t && !te.isNumeric(t))
              )
                g
          ...
          function J() {
            if (Y()) {
              if (
                ...
                d && d.forEach(W),
                "expand" === ne.levelOpen &&
                -1 !== ["top", "bottom"].indexOf(ne.position)
                  ? ee(0)
                  : F() &&
                    (x = setTimeout(
                      function () {
                ...
                ne.disableBody &&
                  (se.body.classList.remove("hc-nav-open"),
              ...
              L._eventListeners.toggle &&
                L._eventListeners.toggle.forEach(function (e) {
                  e.fn(
                    te.customEventObject("toggle", L, L, { action: "close" }),
                    Object.assign({}, ne)
                  );
                }),
                setTimeout(function () {
                  (L.style.visibility = ""),
                    L._eventListeners.close &&
                      L._eventListeners.close.forEach(function (e) {
                        e.fn(
                          te.customEventObject("close", L, L),
                          Object.assign({}, ne)
                        );
                      }),
                    L._eventListeners["close.once"] &&
                      L._eventListeners["close.once"].forEach(function (e) {
                        e.fn(
                          te.customEventObject("close.once", L, L),
                          Object.assign({}, ne)
                        );
                      }),
          ...
          function Z(t, n, e) {
            ...
            L._eventListeners["open.level"] &&
              L._eventListeners["open.level"].forEach(function (e) {
                e.fn(
                  te.customEventObject("open.level", L, o, {
                    currentLevel: t,
                    currentIndex: n,
                  }),
                  Object.assign({}, ne)
          ...
          function ee(t, e) {
            ...
            if (0 < t && L._eventListeners["close.level"]) {
              ...
              L._eventListeners["close.level"].forEach(function (e) {
                e.fn(
                  te.customEventObject("close.level", L, r, {
                    currentLevel: t - 1,
                    currentIndex: K(),
                  }),
                  Object.assign({}, ne)
  ...
  (function (n) {
    ...
    var d = function (e, t, n) {
        ...
        for (var r in t)
          "class" !== r
            ? (t[r] || 0 === t[r]) && a.setAttribute(r, t[r])
            : (a.className = t[r]);
        if (n) {
          Array.isArray(n) || (n = [n]);
