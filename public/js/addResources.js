...
var KTLogin = function() {
	...
	var _handleClientCreate = function() {
		var form = KTUtil.getById('add_resources');
		var formSubmitUrl = KTUtil.attr(form, 'action');
		var formSubmitButton = KTUtil.getById('addNewResourcesubmitbutton');
		...
		FormValidation		
		    ...
		    .on('core.form.valid', function() {
		        ...
		        var form_data = new FormData($("#add_resources")[0]);
				...
				$.ajax({
					...
					success: function (response)
					{
						...
						table.ajax.reload();
						document.getElementById("add_resources").reset();						
