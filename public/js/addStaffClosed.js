...
var KTLogin = function() {
	...
	var _handleClientCreate = function() {
		var form = KTUtil.getById('add_staff_closed');
		var formSubmitUrl = KTUtil.attr(form, 'action');
		var formSubmitButton = KTUtil.getById('addnewcloseddate');
		...
		FormValidation		
		        ...
		        form,
		        {
					...
					{	
						start_date:{
							validators: {
								notEmpty: {
									message: 'you should select start date'
								}
							}
						},
						end_date:{
							validators: {
								notEmpty: {
									message: 'you should select end date'
								}
							}
						},
						description:{
		    ...
		    .on('core.form.valid', function() {
		        ...
		        var form_data = new FormData($("#add_staff_closed")[0]);
				...
				$.ajax({
					...
					success: function (response)
					{
						...
						table.ajax.reload();
						document.getElementById("add_staff_closed").reset();						
