...
function saveclientinformation() {
    ...
    var form_data = new FormData($("#saveClientinfo")[0]);
                ...
                if (checked > 0) {
                    ...
                    if (ischeck == 2) {
                        ...
                        if (temp == 1) {
                            ...
                            html += 'Gender';
                            html += '</label>';
                            html += '<select readonly class="form-control"><option value="">Please select</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option><option value="I dont want to share">I dont want to share</option></select>';
                            html += '</div>';
                            ...
                            if (previewTab.length == 0) {
                                $(".total-preview-tab").text(1);
                                $(".preview-current-steps").text(1);
                                html2 += '<div class="preview-tab cliremove" style="display: block;">';
                            } else { html2 += '<div class="preview-tab cliremove" style="display: none;">'; }
                            ...
                            html2 += '</label>';
                            html2 += '<select readonly class="form-control"><option value="">Please select</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option><option value="I dont want to share">I dont want to share</option></select>';
                            html2 += '</div>';
                            ...
                            if (formsTab.length == 0) {
                                $(".total-forms-tab").text(1);
                                $(".preview-current-steps").text(1);
                                html3 += '<div class="forms-tab cliremove" style="display: block;">';
                            } else { html3 += '<div class="forms-tab cliremove" style="display: none;">'; }
                            ...
                            html3 += '</label>';
                            html3 += '<select readonly class="form-control"><option value="">Please select</option><option value="Male">Male</option><option value="Female">Female</option><option value="Other">Other</option><option value="I dont want to share">I dont want to share</option></select>';
                            html3 += '</div>';
