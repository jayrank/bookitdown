...
fcViews.agendaThreeDay = ThreeDayView;

function ThreeDayView(element, calendar) { // TODO: do a WeekView mixin
	var t = this;
	...
	function render(date) {
		...
		t.intervalStart = date.clone().stripTime().add('day',-1);
		t.intervalEnd = t.intervalStart.clone().add('day',3);
