...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Appointment Cancellations</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getAppointmentCancellationsExcel">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getAppointmentCancellationsCSV">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getAppointmentCancellationsPDF">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            ...
                                            <h3 class="my-4">Appointments by Staff</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover appointmentCancellationsTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Ref #</th>
                                                            <th>Client</th>
    ...
    <script>
        ...
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getAppointmentCancellationsPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'appointment_cancellations_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'appointment_cancellations.pdf';
                }

                $.ajax({
                    url: '{{ route("getAppointmentCancellationsPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getAppointmentCancellationsCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'appointment_cancellations_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'appointment_cancellations.csv';
                }

                $.ajax({
                    url: '{{ route("getAppointmentCancellationsCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getAppointmentCancellationsExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'appointment_cancellations_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'appointment_cancellations.xlsx';
                }

                $.ajax({
                    url: '{{ route("getAppointmentCancellationsExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getAppointmentCancellations(){
            var date = $(".kt_date").val();
            ...
            var datatable = $('.appointmentCancellationsTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "autoWidth": false,
                ...
                "ordering": false,
                ajax : {
                    url: '{{ route("getAppointmentCancellations") }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        start_date: start_date,
                ...
                //     $('.paymentLogTotal').text(json.total);
                // },
                columns: [
                    {data: 'ref', profile: 'ref'},
        ...
        function getAppointmentCancellationsSummary(){
            var date = $(".kt_date").val();
            ...
            $.ajax({
                url: '{{ route("getAppointmentCancellationsSummary") }}',
                type: 'POST',
                dataType: 'JSON',
                data: {
                    start_date: start_date,
                ...
                success: function(response) {
                    if(response.status) {
                        ...
                        summary.forEach(function(summaryValue,summaryKey){
                            if(summaryValue['reason'] === "" || summaryValue['reason'] === null){
                                nullCount = summaryValue['reason_count'];
                            }
                        });

                        summary.forEach(function(summaryValue,summaryKey){
                            if(summaryValue['reason'] === "No reason"){
                                flag = 1;
                                summaryData += '<li class="border-0 list-group-item d-flex justify-content-between align-items-center">'+ summaryValue['reason'] +'<span class="">'+ (summaryValue['reason_count'] + nullCount) +'</span></li>';
                            }else if(summaryValue['reason'] !== "" && summaryValue['reason'] !== null){
                                summaryData += '<li class="border-0 list-group-item d-flex justify-content-between align-items-center">'+ summaryValue['reason'] +'<span class="">'+ summaryValue['reason_count'] +'</span></li>';
                            }else{
                        ...
                        if(flag == 0){
                            summaryData += '<li class="border-0 list-group-item d-flex justify-content-between align-items-center">No reason<span class="">'+ nullCount +'</span></li>';
                        }
        ...
        function callAllFunction(){
            ...
            getAppointmentCancellationsSummary();
        }
    </script>
