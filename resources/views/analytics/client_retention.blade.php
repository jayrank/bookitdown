...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Client retention</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getClientRetentionExcel">
                                                                ...
                                                                <li class="navi-item getClientRetentionCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getClientRetentionPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getClientRetentionTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Name</th>
                                                            <th>Mobile Number</th>
    ...
    <div id="myFilter" class="filter-overlay" style="width:0px;">
        ...
        <div class="filter-overlay-content">
            ...
            <div class="button-action d-flex justify-content-between px-5">
                <button onclick="closeNav()" class="btn-lg btn btn-white w-100 mr-4">
                    Clear
                </button>
                <button class="btn-lg btn btn-primary w-100">
                    Apply
                </button>
            </div>
        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getClientRetentionPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'client_retention_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'client_retention.pdf';
                }

                $.ajax({
                    url: '{{ route("getClientRetentionPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getClientRetentionCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'client_Retention_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'client_Retention.csv';
                }

                $.ajax({
                    url: '{{ route("getClientRetentionCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date
            ...
            $(document).on('click','.getClientRetentionExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'client_retention_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'client_retention.xlsx';
                }

                $.ajax({
                    url: '{{ route("getClientRetentionExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date
        ...
        function getClientRetention(){
            ...
            var datatable = $('.getClientRetentionTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "autoWidth": false,
                ...
                columns: [
                    ...
                    {data: 'days_absent', name: 'days_absent'},
                    {data: 'staff', name: 'staff'},
                    {data: 'last_visit_sales', name: 'last_visit_sales'},
