...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Outstanding invoices</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getOutstandingInvoiceExcel">
                                                                ...
                                                                <li class="navi-item getOutstandingInvoiceCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getOutstandingInvoicePDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white apointment">
                                                <table cellspacing="10" cellpadding="10" class="table outstandingInvoiceTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td class='outstandingInvoiceGrossTotal'></td>
                                                        <td class='outstandingInvoiceTotal'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getOutstandingInvoicePDF', function(){
                KTApp.blockPage();

                var location_id = $("#Locations").val();
                var fileName = 'outstanding_invoice.pdf';

                $.ajax({
                    url: '{{ route("getOutstandingInvoicePDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getOutstandingInvoiceCSV', function(){
                KTApp.blockPage();

                var location_id = $("#Locations").val();
                var fileName = 'outstanding_invoice.csv';

                $.ajax({
                    url: '{{ route("getOutstandingInvoiceCSV") }}',
                    type: 'POST',
                    data: {
                        location_id: location_id
                    },
            ...
            $(document).on('click','.getOutstandingInvoiceExcel', function(){
                KTApp.blockPage();

                var location_id = $("#Locations").val();
                var fileName = 'outstanding_invoice.xlsx';

                $.ajax({
                    url: '{{ route("getOutstandingInvoiceExcel") }}',
                    type: 'POST',
                    data: {
                        location_id: location_id
                    },
        ...
        function getOutstandingInvoice(){
            ...
            var dataTable = $('.outstandingInvoiceTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "ordering": false,
                ajax : {
                    url: '{{ route("getOutstandingInvoices") }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        location_id: location_id
                ...
                "drawCallback":function(settings){
                    ...
                    $('.outstandingInvoiceTotal').text(json.total);
                    $('.outstandingInvoiceGrossTotal').text(json.total);
                },
                columns: [
