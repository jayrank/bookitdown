...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Payments log</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                ...
                                                                <li class="navi-item getPaymentLogCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover paymentLogTable">
                                                    <thead>
                                                        <tr>
                                                            <th>Payment Date</th>
                                                            <th>Location</th>
                                                    ...
                                                    <tbody class="payment_log_data">

                                                    </tbody>
                                                    <tfoot>
                                                        <td colspan="7">Total</td>
                                                        <td class='paymentLogTotal'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
        ...
        <div class="filter-overlay-content">
            <div class="filter-overlay-content p-4">
                ...
                <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" id="selectVouchers">
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getPaymentLogCSV', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'payment_log_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'payment_log.csv';
                }

                $.ajax({
                    url: '{{ route("getPaymentLogCSV") }}',
                    type: 'POST',
                    data: {
        ...
        function getPaymentLog(){
            ...
            var location_id = $("#userLocations").val();
            var staff_id = $("#staffUserID").val();
            var selectVouchers = $("#selectVouchers").val();

            var datatable = $('.paymentLogTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                columns: [
                    {data: 'payment_date', profile: 'payment_date'},
                    ...
                    {data: 'inovice_final_total', name: 'inovice_final_total'},
                ]	
            });
            // return datatable;
        }
