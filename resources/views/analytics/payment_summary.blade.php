...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Payments summary</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getPaymentSummaryExcel">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getPaymentSummaryCSV">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getPaymentSummaryPDF">
                                                                        <span class="navi-icon">
                                                ...
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th scope="col">Gross Payments</th>
                                                            <th scope="col">Refunds</th>
                                                            <th scope="col">Net Payments</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody class="payment_summary_data">
                                                        ...
                                                        <tr class="text-center text-muted">
                                                            <td colspan="10">Showing 3 of 3 results</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getPaymentSummaryPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'payment_summary_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'payment_summary.pdf';
                }

                $.ajax({
                    url: '{{ route("getPaymentSummaryPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getPaymentSummaryCSV', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'payment_summary_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'payment_summary.csv';
                }

                $.ajax({
                    url: '{{ route("getPaymentSummaryCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getPaymentSummaryExcel', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'payment_summary_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'payment_summary.xlsx';
                }

                $.ajax({
                    url: '{{ route("getPaymentSummaryExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
                    ...
                    success: function(response) {
                        KTApp.unblockPage();
                        toastr.success("Excel Downloding!");
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status) {
                        ...
                        // toastr.success((response.message) ? response.message : "Data fetched successfully.");

                        var totalPaymentSummaryData = '';

                        if(response.data['TotalPaymentSummaryData']['gross_total'] > 0){
                            totalPaymentSummaryData += '<tr class="font-weight-bolder"> <td>Total</td><td> '+ response.data['TotalPaymentSummaryTransaction'] +' </td><td> CA $'+ response.data['TotalPaymentSummaryData']['gross_total'].toFixed(2)+'</td><td> CA $'+ (response.data['totalRefundPaymentSummaryData']).toFixed(2) +'</td><td>CA $'+ (response.data['TotalPaymentSummaryData']['gross_total'] - response.data['totalRefundPaymentSummaryData']).toFixed(2) +'</td></tr>';    
                        }else{
                            totalPaymentSummaryData += '<tr class="font-weight-bolder"> <td>Total</td><td>0</td><td> CA $0</td><td> CA $0</td><td>CA $0</td></tr>';
                        }

                        let completedPaymentSummaryData = response.data['completedPaymentSummaryData'];
                        let netPaymentSummaryData = response.data['netPaymentSummaryData'];

                        if((completedPaymentSummaryData.length > 0) && (netPaymentSummaryData.length > 0)){
                            completedPaymentSummaryData.forEach(function (completedPaymentSummaryDataValue, completedPaymentSummaryDataKey)
                            {
                                totalPaymentSummaryData += '<tr class="font-weight-bolder"> <td>'+ completedPaymentSummaryDataValue['payment_type'] +'</td><td> '+ completedPaymentSummaryDataValue['row_count']+' </td><td> CA $'+ completedPaymentSummaryDataValue['gross_total'].toFixed(2)+'</td><td> CA $'+ (completedPaymentSummaryDataValue['gross_total'] - netPaymentSummaryData[completedPaymentSummaryDataKey]['gross_total']).toFixed(2) +'</td><td>CA $'+ netPaymentSummaryData[completedPaymentSummaryDataKey]['gross_total'].toFixed(2) +'</td></tr>'; 
                            });
                        }
                        $('.payment_summary_data').html(totalPaymentSummaryData);
