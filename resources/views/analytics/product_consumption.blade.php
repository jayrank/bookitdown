...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Internal stock consumption </h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getProductConsumptionExcel">
                                                                ...
                                                                <li class="navi-item getProductConsumptionCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getProductConsumptionPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <ul class="list-group summary">
                                                        <li
                                                            ...
                                                            Internal Use Total
                                                            <span class="">
                                                                <span class="getProductConsumptionInternalUseTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                        <li
                                                            class="border-0 list-group-item d-flex justify-content-between align-items-center">
                                                            Damaged Total
                                                            <span class="">
                                                                <span class="getProductConsumptionDamagedTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                        <li
                                                            class="border-0 list-group-item d-flex justify-content-between align-items-center">
                                                            Lost Total
                                                            <span class="">
                                                                <span class="getProductConsumptionLostTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                        <li
                                                            class="border-0 list-group-item d-flex justify-content-between align-items-center">
                                                            Out of Date Total
                                                            <span class="">
                                                                <span class="getProductConsumptionOutOfDateTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                        <li
                                                            class="border-0 list-group-item d-flex justify-content-between align-items-center">
                                                            Adjustment Total
                                                            <span class="">
                                                                <span class="getProductConsumptionAdjustmentTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                        <!-- <li
                                                            class="border-0 list-group-item d-flex justify-content-between align-items-center">
                                                        ...
                                                        <li
                                                            ...
                                                            Other Total
                                                            <span class="">
                                                                <span class="getProductConsumptionOtherTotal">0.00</span>
                                                            </span>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <h3 class="my-4">Internal use</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionInternalUse">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionInternalUseTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionInternalUseTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <h3 class="my-4">Damaged</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionDamaged">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionDamagedTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionDamagedTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <h3 class="my-4">Lost</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionLost">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionLostTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionLostTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <h3 class="my-4">Out of date</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionOutOfDate">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionOutOfDateTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionOutOfDateTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
                                            ...
                                            <h3 class="my-4">Adjustment</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionAdjustment">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionAdjustmentTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionAdjustmentTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <!-- <h3 class="my-4">Transfer</h3>
                                            <div class="table-responsive bg-white rounded">
                                            ...
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductConsumptionOther">
                                                    <thead>
                                                        <tr>
                                                            <th>Product name</th>
                                                            <th>Quantity used</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getProductConsumptionOtherTotalQuantity"></td>
                                                            <td></td>
                                                            <td class="getProductConsumptionOtherTotalCost"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getProductConsumptionPDF', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                var staff_id = $('#staffUserID').val();
                var tableArray = ['getProductConsumptionInternalUse', "getProductConsumptionDamaged", "getProductConsumptionLost", "getProductConsumptionOutOfDate", "getProductConsumptionAdjustment", "getProductConsumptionOther"];
                ...
                if (date != '') {
                    var fileName = 'product_consumption_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'product_consumption.pdf';
                }

                $.ajax({
                    url: '{{ route("getProductConsumptionPDF") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
                        staff_id: staff_id,
                        order_action: tableArray
                    },
                    xhrFields: {
                        responseType: 'blob'
                    },
            ...
            $(document).on('click','.getProductConsumptionCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                var staff_id = $('#staffUserID').val();
                var tableArray = ['getProductConsumptionInternalUse', "getProductConsumptionDamaged", "getProductConsumptionLost", "getProductConsumptionOutOfDate", "getProductConsumptionAdjustment", "getProductConsumptionOther"];
                ...
                if (date != '') {
                    var fileName = 'product_consumption_' + start_date + '.csv';
                } else {
                    var fileName = 'product_consumption.csv';
                }

                $.ajax({
                    url: '{{ route("getProductConsumptionCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getProductConsumptionExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                var staff_id = $('#staffUserID').val();
                var tableArray = ['getProductConsumptionInternalUse', "getProductConsumptionDamaged", "getProductConsumptionLost", "getProductConsumptionOutOfDate", "getProductConsumptionAdjustment", "getProductConsumptionOther"];
                ...
                if (date != '') {
                    var fileName = 'product_consumption_' + start_date +'.xlsx';
                } else {
                    var fileName = 'product_consumption.xlsx';
                }

                $.ajax({
                    url: '{{ route("getProductConsumptionExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getProductConsumption(){
            ...
            tableArray.forEach(function(val){
                var datatable = $('.'+val).DataTable({
                    ...
                    "ordering": false,
                    ajax : {
                        url: '{{ route("getProductConsumption") }}',
                        type: 'POST',
                        dataType: 'JSON',
                        data: {
                            end_date: end_date,
                    ...
                    "drawCallback":function(settings){
                        ...
                        $('.'+ val +'TotalQuantity').text(json.totalQuantity);
                        $('.'+ val +'TotalCost').text(json.totalCost);
                        $('.'+ val +'Total').text(json.totalCost);
                    },
                    columns: [
                        {data: 'product_name', profile: 'product_name'},
                        {data: 'quantity_used', name: 'quantity_used'},
                        {data: 'average_cost_price', name: 'average_cost_price'},
