...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Product sales performance</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getProductSalesPerformanceExcel">
                                                                ...
                                                                <li class="navi-item getProductSalesPerformanceCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getProductSalesPerformancePDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getProductSalesPerformanceTable">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 16%;">Product Name</th>
                                                            <th style="width: 12%;">Stock on Hand</th>
                                                            <th style="width: 12%;">Qty Sold</th>
                                                            <th style="width: 12%;">Cost of Goods Sold</th>
                                                            <th style="width: 12%;">Net Sales</th>
                                                            <th style="width: 12%;">Av. Net Price</th>
                                                            <th style="width: 12%;">Margin</th>
                                                            <th style="width: 12%;">Total Margin</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            ...
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterStockOnHand">0</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterQtySold">0</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterCostOfGoodsSold">CA $0.00</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterNetSales">CA $0.00</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterAverageNetPrice">CA $0.00</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterMargin">0.00%</td>
                                                            <td style="width: 12%;" class="getProductSalesPerformanceTableFooterTotalMargin">CA $0.00</td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
        ...
        <div class="filter-overlay-content">
            <div class="filter-overlay-content p-4">
                    ...
                    <select class="form-control" id="supplierID">
                        ...
                        @if(!empty($Suppliers))
                            @foreach($Suppliers as $SuppliersData)
                                <option value="{{ $SuppliersData['id'] }}">{{ $SuppliersData['supplier_name'] }}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
                <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" id="stockBrand">
                        <option selected value>All Brands</option>
                        @if(!empty($Brands))
                            @foreach($Brands as $BrandsData)
                                <option value="{{ $BrandsData['id'] }}">{{ $BrandsData['brand_name'] }}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
                    ...
                    <select class="form-control" id="stockCategory">
                        ...
                        @if(!empty($Categories))
                            @foreach($Categories as $CategoriesData)
                                <option value="{{ $CategoriesData['id'] }}">{{ $CategoriesData['category_name'] }}</option>
                            @endforeach
                        @endif
                    </select>
                </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getProductSalesPerformancePDF', function(){
                KTApp.blockPage();
                var staff_id = $('#staffUserID').val();
                var supplierID = $("#supplierID").val();
                var stockBrand = $("#stockBrand").val();
                ...
                if (date != '') {
                    var fileName = 'product_sales_performance_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'product_sales_performance.pdf';
                }

                $.ajax({
                    url: '{{ route("getProductSalesPerformancePDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getProductSalesPerformanceCSV', function(){
                KTApp.blockPage();
                var staff_id = $('#staffUserID').val();
                var supplierID = $("#supplierID").val();
                var stockBrand = $("#stockBrand").val();
                ...
                if (date != '') {
                    var fileName = 'product_sales_performance_' + start_date + '.csv';
                } else {
                    var fileName = 'product_sales_performance.csv';
                }

                $.ajax({
                    url: '{{ route("getProductSalesPerformanceCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getProductSalesPerformanceExcel', function(){
                KTApp.blockPage();
                var staff_id = $('#staffUserID').val();
                var supplierID = $("#supplierID").val();
                var stockBrand = $("#stockBrand").val();
                ...
                if (date != '') {
                    var fileName = 'product_sales_performance_' + start_date +'.xlsx';
                } else {
                    var fileName = 'product_sales_performance.xlsx';
                }

                $.ajax({
                    url: '{{ route("getProductSalesPerformanceExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getProductSalesPerformance(){
            var staff_id = $('#staffUserID').val();
            var supplierID = $("#supplierID").val();
            var stockBrand = $("#stockBrand").val();
            var stockCategory = $("#stockCategory").val();
            ...
            var datatable = $('.getProductSalesPerformanceTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "ordering": false,
                ajax : {
                    url: '{{ route("getProductSalesPerformance") }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        staff_id: staff_id,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.getProductSalesPerformanceTableFooterStockOnHand').text(json.getProductSalesPerformanceTableFooterStockOnHand);
                    $('.getProductSalesPerformanceTableFooterQtySold').text(json.getProductSalesPerformanceTableFooterQtySold);
                    $('.getProductSalesPerformanceTableFooterCostOfGoodsSold').text(json.getProductSalesPerformanceTableFooterCostOfGoodsSold);
                    $('.getProductSalesPerformanceTableFooterNetSales').text(json.getProductSalesPerformanceTableFooterNetSales);
                    $('.getProductSalesPerformanceTableFooterAverageNetPrice').text(json.getProductSalesPerformanceTableFooterAverageNetPrice);
                    $('.getProductSalesPerformanceTableFooterMargin').text(json.getProductSalesPerformanceTableFooterMargin);
                    $('.getProductSalesPerformanceTableFooterTotalMargin').text(json.getProductSalesPerformanceTableFooterTotalMargin);
                },
                columns: [
                    {data: 'product_name', profile: 'product_name'},
                    {data: 'stock_on_hand', name: 'stock_on_hand'},
                    {data: 'qty_sold', name: 'qty_sold'},
                    {data: 'cost_of_goods_sold', name: 'cost_of_goods_sold'},
                    {data: 'net_sales', name: 'net_sales'},
                    {data: 'average_net_price', name: 'average_net_price'},
    ...
    <script type="text/javascript">
        ...
        function clearNav(){
            ...
            $("#stockBrand").val($("#stockBrand option:first").val());
            $("#stockCategory").val($("#stockCategory option:first").val());
