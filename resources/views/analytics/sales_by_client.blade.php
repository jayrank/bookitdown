...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Client</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByClientExcel">
                                                                ...
                                                                <li class="navi-item getSalesByClientCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByClientPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Client</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByClientTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByClient_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByClient_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByClientPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_client_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_client.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByClientPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByClientCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_client_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_client.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByClientCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByClientExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_client_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_client.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByClientExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByClient(){
            ...
            var datatable = $('.SalesByClientTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByClient_itemsSold').text(json.total_items_sold);
                    $('.salesByClient_grossSales').text(json.total_gross_sales);
                    $('.salesByClient_discounts').text(json.total_discounts);
                    $('.salesByClient_netSales').text(json.total_net_sales);
                    $('.salesByClient_tax').text(json.total_tax);
                    $('.salesByClient_refunds').text(json.total_refunds);
                    $('.salesByClient_totalSales').text(json.total_total_sales);
                },
                columns: [
