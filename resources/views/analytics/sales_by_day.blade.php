...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Day</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByDayExcel">
                                                                ...
                                                                <li class="navi-item getSalesByDayCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByDayPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Day</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByDayTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByDay_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByDay_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByDayPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_day_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_day.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByDayPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByDayCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_day_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_day.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByDayCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByDayExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_day_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_day.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByDayExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByDay(){
            ...
            var datatable = $('.SalesByDayTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByDay_itemsSold').text(json.total_items_sold);
                    $('.salesByDay_grossSales').text(json.total_gross_sales);
                    $('.salesByDay_discounts').text(json.total_discounts);
                    $('.salesByDay_netSales').text(json.total_net_sales);
                    $('.salesByDay_tax').text(json.total_tax);
                    $('.salesByDay_refunds').text(json.total_refunds);
                    $('.salesByDay_totalSales').text(json.total_total_sales);
                },
                columns: [
