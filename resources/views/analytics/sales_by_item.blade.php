...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by item</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByItemExcel">
                                                                ...
                                                                <li class="navi-item getSalesByItemCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByItemPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by item</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByItemTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByItem_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByItem_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByItemPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_item_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_item.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByItemPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByItemCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_item_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_item.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByItemCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByItemExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_item_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_item.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByItemExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByItem(){
            ...
            var datatable = $('.SalesByItemTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByItem_itemsSold').text(json.total_items_sold);
                    $('.salesByItem_grossSales').text(json.total_gross_sales);
                    $('.salesByItem_discounts').text(json.total_discounts);
                    $('.salesByItem_netSales').text(json.total_net_sales);
                    $('.salesByItem_tax').text(json.total_tax);
                    $('.salesByItem_refunds').text(json.total_refunds);
                    $('.salesByItem_totalSales').text(json.total_total_sales);
                },
                columns: [
