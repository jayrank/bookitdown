...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Location</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByLocationExcel">
                                                                ...
                                                                <li class="navi-item getSalesByLocationCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByLocationPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Location</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByLocationTable">
                                                    <thead>
                                                        <tr>
                                                            <th style="font-weight: bold;">Item</th>
                                                            <th style="font-weight: bold;">Items Sold</th>
                                                            <th style="font-weight: bold;">Gross Sales</th>
                                                            <th style="font-weight: bold;">Discounts</th>
                                                            <th style="font-weight: bold;">Refunds</th>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByLocation_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByLocation_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
        ...
        <div class="filter-overlay-content">
            <div class="filter-overlay-content p-4">
                ...
                <!-- <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" name="channelVariant">
                        <option value="empty">All channels</option>
                        <option value="online">All online channels</option>
                        <option value="fresha">Fresha</option>
                        <option value="book-now-link">Book now link</option>
                        <option value="facebook">Facebook</option>
                        <option value="instagram">Instagram</option>
                        <option value="google-reserve">Google</option>
                        <option value="marketing">Marketing - Smart campaigns</option>
                        <option value="blast-marketing">Marketing - Blast messages</option>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByLocationPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_location_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_location.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByLocationPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByLocationCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_location_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_location.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByLocationCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByLocationExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_location_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_location.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByLocationExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByLocation(){
            ...
            var datatable = $('.SalesByLocationTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByLocation_itemsSold').text(json.total_items_sold);
                    $('.salesByLocation_grossSales').text(json.total_gross_sales);
                    $('.salesByLocation_discounts').text(json.total_discounts);
                    $('.salesByLocation_netSales').text(json.total_net_sales);
                    $('.salesByLocation_tax').text(json.total_tax);
                    $('.salesByLocation_refunds').text(json.total_refunds);
                    $('.salesByLocation_totalSales').text(json.total_total_sales);
                },
                columns: [
