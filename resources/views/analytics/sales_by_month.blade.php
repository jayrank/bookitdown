...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Month</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByMonthExcel">
                                                                ...
                                                                <li class="navi-item getSalesByMonthCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByMonthPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Month</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByMonthTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByMonth_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByMonth_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByMonthPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_month_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_month.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByMonthPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByMonthCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_month_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_month.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByMonthCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByMonthExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_month_' + start_date + '_' + end_date + '.xls';
                } else {
                    var fileName = 'sales_by_month.xls';
                }

                $.ajax({
                    url: '{{ route("getSalesByMonthExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByMonth(){
            ...
            var datatable = $('.SalesByMonthTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByMonth_itemsSold').text(json.total_items_sold);
                    $('.salesByMonth_grossSales').text(json.total_gross_sales);
                    $('.salesByMonth_discounts').text(json.total_discounts);
                    $('.salesByMonth_netSales').text(json.total_net_sales);
                    $('.salesByMonth_tax').text(json.total_tax);
                    $('.salesByMonth_refunds').text(json.total_refunds);
                    $('.salesByMonth_totalSales').text(json.total_total_sales);
                },
                columns: [
