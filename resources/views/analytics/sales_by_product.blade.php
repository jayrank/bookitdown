...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Product</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByProductExcel">
                                                                ...
                                                                <li class="navi-item getSalesByProductCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByProductPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Product</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByProductTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByProduct_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByProduct_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByProductPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_product_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_product.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByProductPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByProductCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_product_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_product.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByProductCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByProductExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_product_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_product.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByProductExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByProduct(){
            ...
            var datatable = $('.SalesByProductTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByProduct_itemsSold').text(json.total_items_sold);
                    $('.salesByProduct_grossSales').text(json.total_gross_sales);
                    $('.salesByProduct_discounts').text(json.total_discounts);
                    $('.salesByProduct_netSales').text(json.total_net_sales);
                    $('.salesByProduct_tax').text(json.total_tax);
                    $('.salesByProduct_refunds').text(json.total_refunds);
                    $('.salesByProduct_totalSales').text(json.total_total_sales);
                },
                columns: [
