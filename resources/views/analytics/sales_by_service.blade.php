...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Service</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByServiceExcel">
                                                                ...
                                                                <li class="navi-item getSalesByServiceCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByServicePDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Service</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByServiceTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByService_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByService_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByService_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByService_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByService_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByService_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByService_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByServicePDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_service_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_service.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByServicePDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByServiceCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_service_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_service.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByServiceCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByServiceExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_service_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_service.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByServiceExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByService(){
            ...
            var datatable = $('.SalesByServiceTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByService_itemsSold').text(json.total_items_sold);
                    $('.salesByService_grossSales').text(json.total_gross_sales);
                    $('.salesByService_discounts').text(json.total_discounts);
                    $('.salesByService_netSales').text(json.total_net_sales);
                    $('.salesByService_tax').text(json.total_tax);
                    $('.salesByService_refunds').text(json.total_refunds);
                    $('.salesByService_totalSales').text(json.total_total_sales);
                },
                columns: [
