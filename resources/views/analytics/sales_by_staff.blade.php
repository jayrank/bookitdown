...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Staff</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByStaffExcel">
                                                                ...
                                                                <li class="navi-item getSalesByStaffCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByStaffPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Staff</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByStaffTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByStaff_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByStaff_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByStaffPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_staff_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_staff.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByStaffPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByStaffCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_staff_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_staff.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByStaffCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByStaffExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_staff_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_staff.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByStaffExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByStaff(){
            ...
            var datatable = $('.SalesByStaffTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByStaff_itemsSold').text(json.total_items_sold);
                    $('.salesByStaff_grossSales').text(json.total_gross_sales);
                    $('.salesByStaff_discounts').text(json.total_discounts);
                    $('.salesByStaff_netSales').text(json.total_net_sales);
                    $('.salesByStaff_tax').text(json.total_tax);
                    $('.salesByStaff_refunds').text(json.total_refunds);
                    $('.salesByStaff_totalSales').text(json.total_total_sales);
                },
                columns: [
