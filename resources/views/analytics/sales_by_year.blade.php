...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Sales by Year</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getSalesByYearExcel">
                                                                ...
                                                                <li class="navi-item getSalesByYearCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getSalesByYearPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-4">Sales by Year</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover SalesByYearTable">
                                                    <thead>
                                                        <tr>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="font-weight: bold;" class='salesByYear_itemsSold'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_grossSales'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_discounts'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_refunds'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_netSales'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_tax'></td>
                                                        <td style="font-weight: bold;" class='salesByYear_totalSales'></td>
                                                    </tfoot>
                                                </table>
                                            </div>
                                        </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getSalesByYearPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'sales_by_year_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'sales_by_year.pdf';
                }

                $.ajax({
                    url: '{{ route("getSalesByYearPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getSalesByYearCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_year_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'sales_by_year.csv';
                }

                $.ajax({
                    url: '{{ route("getSalesByYearCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getSalesByYearExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'sales_by_year_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'sales_by_year.xlsx';
                }

                $.ajax({
                    url: '{{ route("getSalesByYearExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getSalesByYear(){
            ...
            var datatable = $('.SalesByYearTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.salesByYear_itemsSold').text(json.total_items_sold);
                    $('.salesByYear_grossSales').text(json.total_gross_sales);
                    $('.salesByYear_discounts').text(json.total_discounts);
                    $('.salesByYear_netSales').text(json.total_net_sales);
                    $('.salesByYear_tax').text(json.total_tax);
                    $('.salesByYear_refunds').text(json.total_refunds);
                    $('.salesByYear_totalSales').text(json.total_total_sales);
                },
                columns: [
