...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Staff commission detailed</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getStaffCommissionDetailedExcel">
                                                                ...
                                                                <li class="navi-item getStaffCommissionDetailedCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getStaffCommissionDetailedPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white">
                                                <table cellspacing="10" cellpadding="10" class="table getStaffCommissionDetailedTable">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 10%;">Invoice Date</th>
                                                            <th style="width: 10%;">Invoice No.</th>
                                                            <th style="width: 15%;">Staff Member</th>
                                                            <th style="width: 15%;">Item sold</th>
                                                            <th style="width: 10%;">Quantity</th>
                                                            <th style="width: 10%;">Sale value</th>
                                                            <th style="width: 10%;">Commission rate</th>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getStaffCommissionDetailedPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_detailed_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'staff_commission_detailed.pdf';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionDetailedPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getStaffCommissionDetailedCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_detailed_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'staff_commission_detailed.csv';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionDetailedCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getStaffCommissionDetailedExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_detailed_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'staff_commission_detailed.xlsx';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionDetailedExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getStaffCommissionDetailed(){
            var date = $(".kt_date").val();
            ...
            var datatable = $('.getStaffCommissionDetailedTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "autoWidth": false,
                ...
                "ordering": false,
                ajax : {
                    url: '{{ route("getStaffCommissionDetailed") }}',
                    type: 'POST',
                    dataType: 'JSON',
                    data: {
                        start_date: start_date,
                ...
                // },
                columns: [
                    {data: 'invoice_date', profile: 'invoice_date'},
