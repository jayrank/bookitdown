...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Staff commission summary</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getStaffCommissionExcel">
                                                                ...
                                                                <li class="navi-item getStaffCommissionCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getStaffCommissionPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <h3 class="my-2">Commission by staff</h3>
                                            <div class="table-responsive bg-white apointment rounded">
                                                <table class="table table-hover getStaffCommissionTable">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 16%" >Staff Member</th>
                                                            <th style="width: 12%" >Service Sales Total</th>
                                                            <th style="width: 12%" >Service Commission</th>
                                                            <th style="width: 12%" >Product Sales Total</th>
                                                            <th style="width: 12%" >Product Commission</th>
                                                            <th style="width: 12%" >Voucher Sales Total</th>
                                                            <th style="width: 12%" >Voucher Commission</th>
                                                            <!-- <th>Paid Plan Sales Total</th>
                                                            <th>Paid Plan Commission</th> -->
                                                            <th style="width: 12%" >Commission Total</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td class="getStaffComissionTableServiceTotal"></td>
                                                            <td class="getStaffComissionTableServiceCommission"> </td>
                                                            <td class="getStaffComissionTableProductTotal"></td>
                                                            <td class="getStaffComissionTableProductCommission"></td>
                                                            <td class="getStaffComissionTableVoucherTotal"></td>
                                                            <td class="getStaffComissionTableVoucherCommission"></td>
                                                            <!-- <td class="getStaffComissionTable"></td>
                                                            <td class="getStaffComissionTable"></td> -->
                                                            <td class="getStaffComissionTableCommissionTotal"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>

                                            <!-- <h3 class="my-4">Commission by service</h3>
                                            ...
                                            <!-- <h3 class="my-4">Commission by product</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                            ...
                                            <!-- <h3 class="my-4">Commission by voucher</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                            ...
                                            <!-- <h3 class="my-4">Commission by paid plan</h3>
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover">
                                                    <thead>
                                                        <tr>
                                                            <th>Paid Plan Name</th>
                                                            <th>Qty</th>
                                                            <th>Sales Amount</th>
                                                            <th>Refund Amount</th>
                                                            <th>Sales Total</th>
        ...
        <div class="filter-overlay-content">
            <div class="filter-overlay-content p-4">
                <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" id="userLocations">
                ...
                <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" id="staffUserID">
                ...
                <!-- <div class="form-group font-weight-bold">
                    <label for=" select-location font-weight-bold">Vouchers</label>
                    <select class="form-control" id="select-location">
                        <option selected value="include">Include redemptions</option>
                        <option value="exclude">Exclude redemptions</option>
                    </select>
                </div> -->
            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getStaffCommissionPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'staff_commission.pdf';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getStaffCommissionCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'staff_commission.csv';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getStaffCommissionExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'staff_commission_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'staff_commission.xlsx';
                }

                $.ajax({
                    url: '{{ route("getStaffCommissionExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getStaffCommission(){
            ...
            // alert("getStaffCommission");

            var datatable = $('.getStaffCommissionTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.getStaffComissionTableServiceTotal').text(json.serviceSalesTotal);
                    $('.getStaffComissionTableServiceCommission').text(json.serviceCommissionTotal);
                    $('.getStaffComissionTableProductTotal').text(json.productSalesTotal);
                    $('.getStaffComissionTableProductCommission').text(json.productCommissionTotal);
                    $('.getStaffComissionTableVoucherTotal').text(json.voucherSalesTotal);
                    $('.getStaffComissionTableVoucherCommission').text(json.voucherCommissionTotal);
                    $('.getStaffComissionTableCommissionTotal').text(json.commissionTotal);
                },
                columns: [
                    {data: 'staff_member', profile: 'staff_member'},
                    {data: 'service_sales_total', name: 'service_sales_total'},
                    {data: 'service_commission', name: 'service_commission'},
                    {data: 'product_sales_total', name: 'product_sales_total'},
                    {data: 'product_commission', name: 'product_commission'},
                    {data: 'voucher_sales_total', name: 'voucher_sales_total'},
                    {data: 'voucher_commission', name: 'voucher_commission'},
                    {data: 'commission_total', name: 'commission_total'},
                ]	
            });
        }
    </script>
    <script type="text/javascript">
        ...
        function clearNav(){
            $("#staffUserID").val($("#staffUserID option:first").val());
            $("#userLocations").val($("#userLocations option:first").val());
