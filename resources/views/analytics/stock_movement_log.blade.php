...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Stock movement log</h3>
                                            </div>
                                                    ...
                                                    <div class="input-group date">
                                                        <div class="form-group mb-0 mr-2">
                                                            <div class="input-icon" id="kt_daterangepicker_6">
                                                                <input type="text" class="form-control kt_date"
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getStockMovementLogExcel">
                                                                ...
                                                                <li class="navi-item getStockMovementLogCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getStockMovementLogPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white apointment">
                                                <table cellspacing="10" cellpadding="10" class="table getStockMovementLogTable">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" style="width: 14%;">Time & Date</th>
                                                            <th scope="col" style="width: 14%;">Product</th>
                                                            <th scope="col" style="width: 12%;">Barcode</th>
                                                            <th scope="col" style="width: 12%;">Staff</th>
                                                            <th scope="col" style="width: 12%;">Action</th>
                                                            <th scope="col" style="width: 12%;">Adjustment</th>
                                                            <th scope="col" style="width: 12%;">Cost Price</th>
                                                            <th scope="col" style="width: 12%;">On Hand</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
            ...
            <div class="filter-overlay-content p-4">
                ...
                <!-- <div class="form-group font-weight-bold">
                    ...
                    <select class="form-control" id="select-location">
                        <option selected disabled>All Staff</option>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getStockMovementLogPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'stock_movement_log_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'stock_movement_log.pdf';
                }

                $.ajax({
                    url: '{{ route("getStockMovementLogPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getStockMovementLogCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                // var Locations = $('#Locations').val();
                ...
                if (date != '') {
                    var fileName = 'stock_movement_log_' + start_date + '.csv';
                } else {
                    var fileName = 'stock_movement_log.csv';
                }

                $.ajax({
                    url: '{{ route("getStockMovementLogCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getStockMovementLogExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                // var Locations = $('#Locations').val();
                ...
                if (date != '') {
                    var fileName = 'stock_movement_log_' + start_date +'.xlsx';
                } else {
                    var fileName = 'stock_movement_log.xlsx';
                }

                $.ajax({
                    url: '{{ route("getStockMovementLogExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getStockMovementLog(){
            ...
            var datatable = $('.getStockMovementLogTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                // },
                columns: [
                    {data: 'time_and_date', profile: 'time_and_date'},
