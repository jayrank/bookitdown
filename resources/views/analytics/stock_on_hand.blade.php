...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Stock on hand</h3>
                                            </div>
                                            <div class="d-flex justify-content-between">
                                                <div class="calender-div my-2">
                                                    <div class="form-group mb-0">
                                                        <div class="input-icon" id="kt_daterangepicker_1">
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getStockOnHandExcel">
                                                                ...
                                                                <li class="navi-item getStockOnHandCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getStockOnHandPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getStockOnHandTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 12%;">Total Retail Value</th>
                                                            <th style="width: 12%;">Retail Price</th>
                                                            <th style="width: 12%;">Reorder Point</th>
                                                            <th style="width: 12%;">Reorder Amount</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tfoot>
                                                        ...
                                                        <td style="width: 12%;" class="getStockOnHandFooterStockOnHand"></td>
                                                        <td style="width: 12%;" class="getStockOnHandFooterTotalCost"></td>
                                                        <td style="width: 12%;" class="getStockOnHandFooterAverageCost"></td>
                                                        <td style="width: 12%;" class="getStockOnHandFooterTotalRetailValue"></td>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(".kt_date").val(moment().format('dddd, DD/MM/YYYY'));
            ...
            $(document).on('click','.getStockOnHandPDF', function(){
                KTApp.blockPage();
                var start_date = $(".kt_date").val();
                ...
                if (start_date != '') {
                    var fileName = 'stock_on_hand_' + start_date + '.pdf';
                } else {
                    var fileName = 'stock_on_hand.pdf';
                }

                $.ajax({
                    url: '{{ route("getStockOnHandPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getStockOnHandCSV', function(){
                KTApp.blockPage();
                var start_date = $(".kt_date").val();
                ...
                if (start_date != '') {
                    var fileName = 'stock_on_hand_' + start_date + '.csv';
                } else {
                    var fileName = 'stock_on_hand.csv';
                }

                $.ajax({
                    url: '{{ route("getStockOnHandCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        // location_id: location_id,
            ...
            $(document).on('click','.getStockOnHandExcel', function(){
                KTApp.blockPage();
                var start_date = $(".kt_date").val();
                ...
                if (start_date != '') {
                    var fileName = 'stock_on_hand_' + start_date +'.xlsx';
                } else {
                    var fileName = 'stock_on_hand.xlsx';
                }

                $.ajax({
                    url: '{{ route("getStockOnHandExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        // location_id: location_id,
        ...
        function getStockOnHand(){
            ...
            var datatable = $('.getStockOnHandTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.getStockOnHandFooterStockOnHand').text(json.stock_on_hand);
                    $('.getStockOnHandFooterTotalCost').text(json.total_cost);
                    $('.getStockOnHandFooterAverageCost').text(json.average_cost);
                    $('.getStockOnHandFooterTotalRetailValue').text(json.total_retail_value);
                },
                columns: [
                    {data: 'product', profile: 'product'},
                    {data: 'stock_on_hand', name: 'stock_on_hand'},
                    {data: 'total_cost', name: 'total_cost'},
                    {data: 'average_cost', name: 'average_cost'},
                    {data: 'total_retail_value', name: 'total_retail_value'},
                    {data: 'retail_price', name: 'retail_price'},
                    {data: 'reorder_point', name: 'reorder_point'},
                    {data: 'reorder_amount', name: 'reorder_amount'},
                ]	
            });
        }
