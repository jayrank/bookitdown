...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Taxes summary</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getTaxesSummaryExcel">
                                                                ...
                                                                <li class="navi-item getTaxesSummaryCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getTaxesSummaryPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover getTaxesSummaryTable">
                                                    <thead>
                                                        <tr>
                                                            <th style="width: 20%">Tax</th>
                                                            <th style="width: 20%">Location</th>
                                                            <th style="width: 20%">Item Sale</th>
                                                    ...
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            <td>Total</td>
                                                            <td colspan="3"></td>
                                                            <td class="getTaxesSummaryTableTotal"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getTaxesSummaryPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'taxes_summary_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'taxes_summary.pdf';
                }

                $.ajax({
                    url: '{{ route("getTaxesSummaryPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getTaxesSummaryCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'taxes_summary_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'taxes_summary.csv';
                }

                $.ajax({
                    url: '{{ route("getTaxesSummaryCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getTaxesSummaryExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'taxes_summary_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'taxes_summary.xlsx';
                }

                $.ajax({
                    url: '{{ route("getTaxesSummaryExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getTaxesSummary(){
            ...
            var datatable = $('.getTaxesSummaryTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.getTaxesSummaryTableTotal').text(json.total);
                },
                columns: [
                    {data: 'tax', profile: 'tax'},
                    {data: 'location', name: 'location'},
                    {data: 'item_sales', name: 'item_sales'},
                    {data: 'tax_rates', name: 'rate'},
