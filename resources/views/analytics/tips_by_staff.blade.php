...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Tips by staff</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item getTipsByStaffExcel">
                                                                ...
                                                                <li class="navi-item getTipsByStaffCSV">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item getTipsByStaffPDF">
                                                                    <a href="#" class="navi-link">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white">
                                                <table cellspacing="10" cellpadding="10" class="table getTipsByStaffTable">
                                                    <thead>
                                                        <tr>
                                                            <th scope="col" style="width: 20%">Employee Name</th>
                                                            <th scope="col" style="width: 20%">Collected Tips</th>
                                                            <th scope="col" style="width: 20%">Refunded Tips</th>
                                                            <th scope="col" style="width: 20%">Total Tips</th>
                                                            <th scope="col" style="width: 20%">Average Tip</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    ...
                                                    <tfoot>
                                                        <tr>
                                                            ...
                                                            <td style="width: 20%" class="getTipsByStaffTableFooterCollectedTips"></td>
                                                            <td style="width: 20%" class="getTipsByStaffTableFooterRefundedTips"></td>
                                                            <td style="width: 20%" class="getTipsByStaffTableFooterTotalTips"></td>
                                                            <td style="width: 20%" class="getTipsByStaffTableFooterAverageTips"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getTipsByStaffPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'tips_by_staff_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'tips_by_staff.pdf';
                }

                $.ajax({
                    url: '{{ route("getTipsByStaffPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getTipsByStaffCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'tips_by_staff_' + start_date + '_' + end_date + '.csv';
                } else {
                    var fileName = 'tips_by_staff.csv';
                }

                $.ajax({
                    url: '{{ route("getTipsByStaffCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getTipsByStaffExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                ...
                if (date != '') {
                    var fileName = 'tips_by_staff_' + start_date + '_' + end_date + '.xlsx';
                } else {
                    var fileName = 'tips_by_staff.xlsx';
                }

                $.ajax({
                    url: '{{ route("getTipsByStaffExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getTipsByStaff(){
            ...
            var datatable = $('.getTipsByStaffTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.getTipsByStaffTableFooterCollectedTips').text(json.collectedTipsTotal);
                    $('.getTipsByStaffTableFooterRefundedTips').text(json.refundedTipsTotal);
                    $('.getTipsByStaffTableFooterTotalTips').text(json.totalTips);
                    $('.getTipsByStaffTableFooterAverageTips').text(json.averageTipsTotal);
                },
                columns: [
                    {data: 'employee_name', profile: 'employee_name'},
                    {data: 'collected_tip', name: 'collected_tip'},
                    {data: 'refunded_tips', name: 'refunded_tips'},
                    {data: 'total_tips', name: 'total_tips'},
                    {data: 'average_tips', name: 'average_tips'},
                ]	
            });
        }
    </script>
