...
@section('content')
                                    ...
                                    <div class="card-custom card-stretch gutter-b">
                                        ...
                                        <div class="content-header" style="margin-top:2%">
                                            <div class="mb-3">
                                                ...
                                                <h3 class="my-3 font-weight-bolder">Tips collected</h3>
                                            </div>
                                                    ...
                                                    <div class="dropdown dropdown-inline mr-2">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                                            ...
                                                            <ul class="navi flex-column navi-hover py-2">
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getTipsCollectedExcel">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getTipsCollectedCSV">
                                                                        <span class="navi-icon">
                                                                ...
                                                                <li class="navi-item">
                                                                    <a href="#" class="navi-link getTipsCollectedPDF">
                                                                        <span class="navi-icon">
                                        ...
                                        <div class="row reports mx-1 my-3">
                                            <div class="table-responsive bg-white rounded">
                                                <table class="table table-hover tipsCollectedTable">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            <th style="width: 20%">Tips Collected</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                    </tbody>
                                                    <tfoot>
                                                        <tr class="font-weight-bolder">
                                                            ...
                                                            <td style="width: 20%" class="tipsCollectedTotal"></td>
                                                        </tr>
                                                    </tfoot>
                                                </table>
                                            </div>
    ...
    <script>
        jQuery(document).ready(function () {
            ...
            $(document).on('click','.getTipsCollectedPDF', function(){
                KTApp.blockPage();
                ...
                if (date != '') {
                    var fileName = 'tips_collected_' + start_date + '_' + end_date + '.pdf';
                } else {
                    var fileName = 'tips_collected.pdf';
                }

                $.ajax({
                    url: '{{ route("getTipsCollectedPDF") }}',
                    type: 'POST',
                    data: {
            ...
            $(document).on('click','.getTipsCollectedCSV', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                var staff_id = $('#staffUserID').val();
                var location_id = $('#userLocations').val();
                ...
                if (date != '') {
                    var fileName = 'tips_collected_' + start_date + '.csv';
                } else {
                    var fileName = 'tips_collected.csv';
                }

                $.ajax({
                    url: '{{ route("getTipsCollectedCSV") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
            ...
            $(document).on('click','.getTipsCollectedExcel', function(){
                KTApp.blockPage();
                var date = $(".kt_date").val();
                var staff_id = $('#staffUserID').val();
                var location_id = $('#userLocations').val();
                ...
                if (date != '') {
                    var fileName = 'tips_collected_' + start_date +'.xlsx';
                } else {
                    var fileName = 'tips_collected.xlsx';
                }

                $.ajax({
                    url: '{{ route("getTipsCollectedExcel") }}',
                    type: 'POST',
                    data: {
                        start_date: start_date,
                        end_date: end_date,
        ...
        function getTipsCollected(){
            ...
            var datatable = $('.tipsCollectedTable').DataTable({
                processing: true,
                serverSide: true,
                destroy: true,
                "searching": false,
                ...
                "drawCallback":function(settings){
                    ...
                    $('.tipsCollectedTotal').text(json.total);
                },
                columns: [
                    {data: 'date', name: 'date'},
                    ...
                    {data: 'tips_collected', name: 'tips_collected'},
                ]	
            });
        }
    </script>
