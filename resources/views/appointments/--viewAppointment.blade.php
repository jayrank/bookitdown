	...
	<div class="my-custom-body-wrapper">
		<div class="my-custom-header">
			<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
				...
				<span class="d-flex">
					<p class="cursor-pointer m-0 px-6" onclick="window.close()"><i class="text-dark fa fa-times icon-lg"></i></p><!-- history.back(); -->
				</span>
			</div>
		</div>
								...
								<div class="">
									...
									<div class="d-flex flex-wrap align-items-center justify-content-between w-100">
										<div class="d-flex flex-column align-items-cente py-2 w-75">
											<h6 class="text-dark-75 font-weight-bolder font-size-lg">{{ $ClientServiceData['start_time'] }} <span class="ml-8">{{ $ClientServiceData['service_pricing_name'] }}</span></h6>
