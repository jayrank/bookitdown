		...
		<div class="my-custom-body-wrapper">
			<div class="my-custom-header bg-white">
				<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
					...
					<h1 class="font-weight-bolder">Cancellation Notification</h1>
				...
				<div class="container-fluid bg-content">
					<div class="row">
						<div class="col-12 col-md-4 p-0 bg-content" style="height:calc(100vh - 80px);overflow-y:scroll">
							<form name="cancellationMessage" id="cancellationMessage">
							<div class="p-4">
								...
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($can->is_cancellationMessage) && $can->is_cancellationMessage==1)checked @endif name="is_cancellationMessage"
												type="checkbox">
											<span></span> Enable cancellation messages
										</label>
									</div>
								</div>
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($can->is_displayServicePrice) && $can->is_displayServicePrice==1)checked @endif name="is_displayServicePrice" id="is_displayServicePrice"
												type="checkbox">
								...
								<div class="form-group">
									...
									<textarea rows="4" class="form-control" name="important_info" id="note"
										placeholder="e.g. Parking is available on the street">@if(isset($can->important_info) && $can->important_info!=null){{ $can->important_info }} @endif</textarea>
								</div>
							</div>
							</form>
						</div>
													...
													<div class="tab-content" id="myTabContent1">
														<div class="tab-pane fade active show" id="email"
															...
															<div class="card-body bg-dark text-white">
																<div class="message">
																	<h3>Hi {{ $client->firstname }} {{ $client->lastname }}, your appointment is cancelled!</h3>
																	<span
																		class="mb-3 badge badge-pill badge-danger">Cancelled</span>
...
<script>
			...
			FormValidation
				...
				.on('core.form.valid', function() {
					...
					$.ajax({
						...
						data: {email : email, is_price_view : is_price_view, note : note, type : 5},		
	...
	$(document).on('click','#update', function(){
		var form = $("#cancellationMessage");
		$.ajax({
			type: "POST",
			url: "{{ route('updatecancellationNotifi') }}",
			headers:{
						'X-CSRF-Token': '{{ csrf_token() }}',
					},
			data: form.serialize(),
