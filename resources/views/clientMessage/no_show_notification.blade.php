		...
		<div class="my-custom-body-wrapper">
			<div class="my-custom-header bg-white">
				<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
					...
					<h1 class="font-weight-bolder">No Show Notification</h1>
				...
				<div class="container-fluid bg-content">
					<div class="row">
						<div class="col-12 col-md-4 p-0 bg-content" style="height:calc(100vh - 80px);overflow-y:scroll">
							<form name="noshowmessage" id="noshowmessage">							
							<div class="p-4">
								...
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($noshow->is_noShowMessage) && $noshow->is_noShowMessage==1)checked @endif name="is_noShowMessage"
												type="checkbox">
											<span></span> Enable no-show messages
										</label>
									</div>
								</div>
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($noshow->is_displayServicePrice) && $noshow->is_displayServicePrice==1)checked @endif name="is_displayServicePrice" id="is_displayServicePrice"
												type="checkbox">
								...
								<div class="form-group">
									...
									<textarea rows="4" class="form-control" id="note" name="important_info"
										placeholder="e.g. Parking is available on the street">@if(isset($noshow->important_info) && $noshow->important_info!=null){{ $noshow->important_info }} @endif</textarea>
								</div>
							</div>
							</form>
						</div>
													...
													<div class="tab-content" id="myTabContent1">
														<div class="tab-pane fade active show" id="email"
															...
															<div class="card-body bg-dark text-white">
																<div class="message">
																	<h3>Hi {{ $client->firstname }} {{ $client->lastname }}, you did not show up</h3>
																	<span
																		class="mb-3 badge badge-pill badge-danger">No-Show</span>
...
<script>
			...
			FormValidation
				...
				.on('core.form.valid', function() {
					...
					$.ajax({
						...
						data: {email : email, is_price_view : is_price_view, note : note, type : 6},		
	...
	$(document).on('click','#update', function(){
		var form = $("#noshowmessage");
		$.ajax({
			type: "POST",
			url: "{{ route('updatenoShowNotifi') }}",
			headers:{
						'X-CSRF-Token': '{{ csrf_token() }}',
					},
			data: form.serialize(),
