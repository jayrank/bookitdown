		...
		<div class="my-custom-body-wrapper">
			<div class="my-custom-header bg-white">
				<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
					...
					<h1 class="font-weight-bolder">Thank You For Tipping Notification</h1>
				...
				<div class="container-fluid bg-content">
					<div class="row">
						<div class="col-12 col-md-4 p-0 bg-content" style="height:calc(100vh - 80px);overflow-y:scroll">
							<form name="tippingmessage" id="tippingmessage">					
							<div class="p-4">
								...
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($tip->is_message) && $tip->is_message==1)checked @endif name="is_message"
												type="checkbox">
											<span></span> Enable messages
										</label>
									</div>
								</div>
								<div class="form-group">
									<div class="checkbox-list mt-8">
										<label class="checkbox font-weight-bolder">
											<input @if(isset($tip->is_displayServicePrice) && $tip->is_displayServicePrice==1)checked @endif name="is_displayServicePrice" id="is_displayServicePrice"
												type="checkbox">
								...
								<div class="form-group">
									...
									<textarea rows="4" class="form-control" id="note" name="important_info"
										placeholder="e.g. Parking is available on the street">@if(isset($tip->important_info) && $tip->important_info!=null){{ $tip->important_info }} @endif</textarea>
								</div>
							</div>
							</form>
						</div>
													...
													<div class="tab-content" id="myTabContent1">
														<div class="tab-pane fade active show" id="email"
															...
															<div class="card-body bg-dark text-white">
																<div class="message">
																	<h3>Thanks for tipping {{ $client->firstname }} {{ $client->lastname }}!</h3>
																	<span
															...
															<div class="bg-secondary p-3">
																<div class="d-flex justify-content-between">
																	...
																	<h3 class="font-weight-bolder">CA${{ $service->servicePrice[0]->price }}</h3>
																</div>
																<hr>
																...
																<hr id="ser">
																<div class="total d-flex justify-content-between">
																	<h6 class="font-weight-bolder">PAid by card</h6>
...
<script>
			...
			FormValidation
				...
				.on('core.form.valid', function() {
					...
					$.ajax({
						...
						data: {email : email, is_price_view : is_price_view, note : note, type : 7},		
	...
	$(document).on('click','#update', function(){
		var form = $("#tippingmessage");
		$.ajax({
			type: "POST",
			url: "{{ route('updatetippingNotifi') }}",
			headers:{
						'X-CSRF-Token': '{{ csrf_token() }}',
					},
			data: form.serialize(),
