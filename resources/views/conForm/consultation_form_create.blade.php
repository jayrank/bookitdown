...
@section('content')
			...
			<div class="my-custom-header bg-white"> 
	            <div class="p-5" style="flex-shrink: 0; display: grid; grid-template-columns: 1fr auto 1fr; align-items: center;">
		            ...
		            <div style="display: flex; flex-grow: 1; grid-auto-flow: column; justify-content: flex-end;">
		                <button class="btn btn-primary next-step" onclick="nextPrev(1)">Next Step</button>
		                <button class="btn btn-primary" id="fullsave">Save</button>
		            </div>
		        </div>
	        </div> 
						...
						<div class="row">
							<div class="col-12 col-md-2 p-0 border-right"
								...
								<div class="">
									...
									<div class="card shadow-sm w-50 mx-auto mb-4 cursor-pointer showclientmodal add" data-toggle="modal"
									...
									<div class="card shadow-sm w-50 mx-auto mb-4">
										<div class="card-body px-4 py-6">
											...
											<p class="font-weight-bolder text-muted text-center m-0">Marketing
												preferences</p>
										</div>
									</div-->
									<hr>
									<div class="card shadow-sm w-50 mx-auto mb-4 cursor-pointer" data-toggle="modal" data-target="#addCustomSectionModal">
										<div class="card-body px-4 py-6">
											<div class="mx-auto" style="height: 32px;width: 32px;">
												<svg viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
													<path
							...
							<div class="col-12 col-md-10 bg-content"
								...
								<div id="ClientInfoShow" style="display: none">
									<ul class="nav nav-pills round-nav mx-auto hideOnNull" id="myTab1" role="tablist"
										style="width:240px">
										<li class="nav-item font-weight-bolder">
											<a class="nav-link active" id="builder-tab-1" data-toggle="tab"
												href="#builder">
									...
									<div class="tab-content" id="myTabContent1">
										<div class="tab-pane fade active show" id="builder" role="tabpanel" aria-labelledby="builder-tab-1" >
											<div class="card w-70 mx-auto mt-16 customse " style="display: none">
												<div id="appenddata">
										...
										<div class="tab-pane fade" id="preview" role="tabpanel" aria-labelledby="preview-tab-1">
											<div class="card w-50 mx-auto my-4">
												<div class="card-header text-center">
													...
													<h6>step <span class="preview-current-steps setp1" ></span> of <span
															class="total-preview-tab setp2" ></span></h6>
													<h3 class="font-weight-bolder title" ></h3>
													<h6 class="m-0 text-dakr-50 sectionDes" ></h6>
												</div>
												<div class="apppreview">
													
												</div>
												<div class="card-footer text-right">
													<button class="preview-next btn btn-primary" disabled
														onclick="nextPrevPreview(1)">Next
														Step</button>
													<button class="preview-previous btn btn-white" style="display: none"
								...
								<form name="formdetail" id="formdetail">
									...
									<div class="form-group">
										<div class="form-group ml-2 w-100 d-flex extra-time">
											...
											<!--label class="option m-3">
												<span class="option-control">
													<span class="radio">
														<input type="radio" disabled name="send_request" value="manually">
														<span></span>
													</span>
												</span>
												<span class="option-label">
									...
									<div class="form-group">
										...
										<select class="form-control" name="complete">
											<option value="0">Every time they book an
												appointment</option>
													...
													<div class="modal-body">
														<div class="form-group">
															<div class="input-icon input-icon-right">
																<input type="text" class="rounded-0 form-control searchForCategory"
							...
							<div class="col-12 col-md-8 p-4"
								...
								<div class="card w-70 mx-auto">
									<div class="card-header text-center">
										...
										<h6>step <span class="forms-current-steps">1</span> of <span
												class="total-forms-tab">1</span></h6>
										<h3 class="font-weight-bolder title" ></h3>
										<h6 class="sectionDes "></h6>
									</div>
									<div class="appendpre">
									...
									<div class="card-footer text-right">
										<button class="forms-next btn btn-primary" onclick="nextPrevForms(1)">Next
											Step</button>
										<button class="forms-previous btn btn-white" onclick="nextPrevForms(-1)">Previous Step</button>
									</div>
								</div>
							</div>
						</div>
	...
	<div class="modal fade" id="addNewSectionModal" tabindex="-1" role="dialog"
		aria-labelledby="addNewSectionModalLabel" aria-hidden="true">
				...
				<div class="modal-body">
					...
					<div>
						<ul class="ks-cboxtags ">
							<li class="showclientmodal add" data-toggle="modal" data-target="#addClientDetailModal" data-dismiss="modal">
	...
	<div class="modal fade" id="addNewQuestionModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<div>
						<ul class="ks-cboxtags question">
							<li><input type="radio" name="question" id="short-ans" value="shortAnswer">
							...
							<li><input type="radio" name="question" id="long-ans" value="longAnswer">
							...
							<li><input type="radio" name="question" id="single-ans" value="singleAnswer">
							...
							<li><input type="radio" name="question" id="single-checkbox" value="singleCheckbox">
							...
							<li><input type="radio" name="question" id="multi-choice" value="multipleCheckbox">
							...
							<li><input type="radio" name="question" id="drop-down" value="dropdown">
							...
							<li><input type="radio" name="question" id="description-text" value="des">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
					<button type="button" class="btn btn-primary " data-dismiss="modal" id="addnewqnatomodel">Add</button>
				</div>
			</div>
		</div>
	</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="form-group">
						...
						<input type="text" name="sectiontitle" id="sectiontitle" placeholder="add title" class="form-control">
					</div>
					<div class="form-group">
						<label class="font-weight-bolder">Section description <span
								class="text-muted">(Optional)</span></label>
						<input type="text" name="sectiondes" id="sectiondes" placeholder="add description" class="form-control">
					</div>
				</div>
				<div class="modal-footer">
					<button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
	...
	<div class="modal fade" id="addClientDetailModal" tabindex="-1" role="dialog"
		...
		<div class="modal-dialog" role="document">
			<form name="saveClientinfo" id="saveClientinfo" action="{{ route('conFormClientInfo') }}">
				@csrf
				<input type="hidden" name="clientse_id" id="secton_id">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="addClientDetailModalLabel"><span id="showtext"></span> a client details section</h5>
						<p class="cursor-pointer m-0 px-2" data-dismiss="modal" aria-label="Close"><i
								class="text-dark fa fa-times icon-lg"></i>
						</p>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label class="font-weight-bolder">Section title</label>
							<input type="text" name="section_title" id="section_title" placeholder="add title" class="form-control">
						</div>
						<div class="form-group">
							<label class="font-weight-bolder">Section description <span
									class="text-muted">(Optional)</span></label>
							<input type="text" name="section_des" id="section_des" placeholder="add description" class=" form-control">
						</div>
						<hr>
							...
							<div class="row">
									...
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="first_name" id="first_name" type="checkbox" checked>
								...
								<div class="col-12 col-sm-12 col-md-6" >
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="last_name" id="last_name" type="checkbox" checked>
												<span></span> Last Name
											</label>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="email" id="email" type="checkbox" checked>
												<span></span> Email
											</label>
										</div>
									</div>
								...
								<div class="col-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="birthday" id="birthday" type="checkbox" checked>
												<span></span> Birthday
											</label>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder"> 
												<input name="mobile" id="mobile" type="checkbox" checked>
								...
								<div class="col-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="gender" id="gender" type="checkbox" checked>
												<span></span> Gender
											</label>
										</div>
									</div>
							...
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6">
									<div class="form-group">
										<div class="checkbox-list">
											<label class="checkbox font-weight-bolder">
												<input name="address" id="address" type="checkbox" checked>
												<span></span> Address
											</label>
										</div>
									</div>
...
@section('scripts')
	...
	<script>
		...
		jQuery(document).ready(function() {
			...
			$(document).on('click','#fullsave', function(){
				...
				if (formname == '') {
					...
					$.ajax({
						...
						url: '{{ route('conFormClientInfo') }}',//'partners/conFormClientInfo',
						data: {formdata:$("#formdetail").serialize(),client:$("#saveClientinfo").serialize(),filterdata},
			...
			$(document).on('click','#deleteClinemo', function(){
				...
				var sectionLength = $(".sectionHtml").length;
			...
			$(document).on('click','.deleteNewQnaCus', function(){
				var qna = $(this).closest('form').find('.showdata').length;
			...
			$(document).on('click','.copyNewQnaCus', function(){
				var clonedata = $(this).closest('.showdata').clone(true);
				...
				if (qna == '') {
					...
					html+='<div class="form-group showedit">';
						...
						if(ans=='des'){
							...
							html += '<label class="font-weight-bolder">'+ansdata+'</label>';
							html += '<textarea rows="3" class="form-control" style="display:none;">'+ansdata+'</textarea>';
						}

					html+='</div>';
					var html1 = '';
					var formsTab = document.getElementsByClassName("forms-tab");
					if(formsTab.length ==0 ){ $(".total-forms-tab").text(1);
					var divid12 = qna.replace(/ /g,"_");
					$(".preview-current-steps").text(1);html1 += '<div class="forms-tab remove'+secid+' next'+divid12+'" style="display: block;">';}else{ html1 += '<div class="forms-tab remove'+secid+' next'+divid12+'" style="display: none;">'; }
					html1 += '<div class="card-body">';
					html1 += '<div class="form-group">';
					if(ans=='des'){
						
					} else {
						html1+='<label class="font-weight-bolder">'+qna+'</label>';
					}
					if(ans=='shortAnswer'){
						html1+='<input type="text" class="form-control" >';
					}
					if(ans=='longAnswer'){
						html1+='<textarea rows="3" class="form-control" ></textarea>';
					}
					if(ans=='singleAnswer'){
						html1+='<div class="radio-list">';
						for(i=1; i<= ansInput; i++){
							var ansdata = $(this).closest('.card').find('#ans'+i).val();
							
							html1+='<label class="radio">';
							html1+='<input type="radio" value="'+ansdata+'" >';
							html1+='<span></span>'+ansdata+'</label>';
						}
						html1+='</div>';
					}
					if(ans=='singleCheckbox'){
						html1+='<input type="checkbox" class="form-control" >';
					}
					if(ans=='multipleCheckbox'){
						html1+='<div class="checkbox-list">';
						for(i=1; i<= ansInput; i++){
							var ansdata = $(this).closest('.card').find('#ans'+i).val();
							
							html1+='<label class="checkbox">';
							html1+='<input type="checkbox" value="'+ansdata+'" >';
							html1+='<span></span>'+ansdata+'</label>';
						}
						html1+='</div>';
					}
					if(ans=='dropdown'){
						html1+='<div class="dropdown">';
							html1+='<select class="custom-select" >';
							html1+='<option disable>Choose...</option>';
						for(i=1; i<= ansInput; i++){
							var ansdata = $(this).closest('.card').find('#ans'+i).val();
							html1+='<option selected value="'+ansdata+'">'+ansdata+'</option>';
					...
					if(ans=='yesOrNo'){
						html1+='<div class="form-group ml-2 w-100 d-flex extra-time">';
							html1+='<label class="option m-3">';
								html1+='<span class="option-control">';
									html1+='<span class="radio">';
										html1+='<input type="radio" value="Yes">';
										html1+='<span></span>';
									html1+='</span>';
								html1+='</span>';
								html1+='<span class="option-label">';
									html1+='<span class="option-head">';
										html1+='<span class="option-title">Yes</span>';
									html1+='</span>';
								html1+='</span>';
							html1+='</label>';
							html1+='<label class="option m-3">';
								html1+='<span class="option-control">';
									html1+='<span class="radio">';
										html1+='<input type="radio" value="No">';
										html1+='<span></span>';
									html1+='</span>';
								html1+='</span>';
								html1+='<span class="option-label">';
									html1+='<span class="option-head">';
										html1+='<span class="option-title">No</span>';
									html1+='</span>';
								html1+='</span>';
							html1+='</label>';
						html1+='</div>';
					...
					if(ans=='des'){
						var ansdata = $(this).closest('.card').find('#ans1').val();
							html1 += '<label class="font-weight-bolder">'+ansdata+'</label>';
							html1 += '<textarea rows="3" class="form-control" style="display:none;" >'+ansdata+'</textarea>';
					}
					html1 += '</div>';
					html1 += '</div>';
					html1 += '</div>';

					$(".appendpre").append(html1);
					var previewTab = document.getElementsByClassName("preview-tab");
					var divid1 = qna.replace(/ /g,"_");

					var html2 = '';
					if(previewTab.length ==0 ){ $(".total-preview-tab").text(1);
					$(".preview-current-steps").text(1);html2 += '<div class="preview-tab remove'+secid+' '+divid1+'" style="display: block;">';}else{ html2 += '<div class="preview-tab remove'+secid+' '+divid1+'" style="display: none;">'; }
					html2 += '<div class="card-body">';
					html2 += '<div class="form-group">';
						if(ans=='des'){
						
						} else {
							html2+='<label class="font-weight-bolder">'+qna+'</label>';
						}
						if(ans=='shortAnswer'){
							html2+='<input type="text" class="form-control" >';
						}
						if(ans=='longAnswer'){
							html2+='<textarea rows="3" class="form-control" ></textarea>';
						}
						if(ans=='singleAnswer'){
							html2+='<div class="radio-list">';
							for(i=1; i<= ansInput; i++){
								var ansdata = $(this).closest('.card').find('#ans'+i).val();
								
								html2+='<label class="radio">';
								html2+='<input type="radio" value="'+ansdata+'" >';
								html2+='<span></span>'+ansdata+'</label>';
							}
							html2+='</div>';
						}
						if(ans=='singleCheckbox'){
							html2+='<input type="checkbox" class="form-control" >';
						}
						if(ans=='multipleCheckbox'){
							html2+='<div class="checkbox-list">';
							for(i=1; i<= ansInput; i++){
								var ansdata = $(this).closest('.card').find('#ans'+i).val();
								
								html2+='<label class="checkbox">';
								html2+='<input type="checkbox" value="'+ansdata+'" >';
								html2+='<span></span>'+ansdata+'</label>';
							}
							html2+='</div>';
						}
						if(ans=='dropdown'){
							html2+='<div class="dropdown">';
								html2+='<select class="custom-select" >';
								html2+='<option disable>Choose...</option>';
							for(i=1; i<= ansInput; i++){
								var ansdata = $(this).closest('.card').find('#ans'+i).val();
								html2+='<option selected value="'+ansdata+'">'+ansdata+'</option>';
						...
						if(ans=='yesOrNo'){
							html2+='<div class="form-group ml-2 w-100 d-flex extra-time">';
								html2+='<label class="option m-3">';
									html2+='<span class="option-control">';
										html2+='<span class="radio">';
											html2+='<input type="radio" value="Yes">';
											html2+='<span></span>';
										html2+='</span>';
									html2+='</span>';
									html2+='<span class="option-label">';
										html2+='<span class="option-head">';
											html2+='<span class="option-title">Yes</span>';
										html2+='</span>';
									html2+='</span>';
								html2+='</label>';
								html2+='<label class="option m-3">';
									html2+='<span class="option-control">';
										html2+='<span class="radio">';
											html2+='<input type="radio" value="No">';
											html2+='<span></span>';
										html2+='</span>';
									html2+='</span>';
									html2+='<span class="option-label">';
										html2+='<span class="option-head">';
											html2+='<span class="option-title">No</span>';
										html2+='</span>';
									html2+='</span>';
								html2+='</label>';
							html2+='</div>';
						...
						if(ans=='des'){
							var ansdata = $(this).closest('.card').find('#ans1').val();
							html2 += '<label class="font-weight-bolder">'+ansdata+'</label>';
							html2 += '<textarea rows="3" class="form-control" style="display:none;">'+ansdata+'</textarea>';
						}
					html2 += '</div>';
					html2 += '</div>';
					html2 += '</div>';
					...
					html += '<div class="d-flex justify-content-between">';
						html += '<div class="form-group mb-0 mr-2 w-100">';
							html += '<div class="form-group">';
								...
								html += '</label>';
								html += '<input type="text" required="required" class="form-control ans" id="ans1">';
							html += '</div>';
						html += '</div>';
					html += '</div>';
					html+='<div class="d-flex justify-content-between ">';
						html+='<div class="form-group mb-0 mr-2 w-100">';
							html+='<div class="form-group">';
								...
								html+='</label>'; 
								html+='<input type="text" required="required" class="form-control ans" id="ans2">';
							html+='</div>';
						html+='</div>';
					...
					html += '<div class="d-flex justify-content-between">';
						html += '<div class="form-group mb-0 mr-2 w-100">';
							html += '<div class="form-group">';
								html += '<label class="font-weight-bolder">	Answer 1 ';
								html += '</label>';
								html += '<input type="text" class="form-control ans" required="required" id="ans1">';
							html += '</div>';
						html += '</div>';
					html += '</div>';
					html+='<div class="d-flex justify-content-between ">';
						html+='<div class="form-group mb-0 mr-2 w-100">';
							html+='<div class="form-group">';
								html+='<label class="font-weight-bolder"> Answer 2 ';
								html+='</label>';
								html+='<input type="text" class="form-control ans" required="required" id="ans2">';
							html+='</div>';
						html+='</div>';
					html+='</div><div class="newsignappans' + id + '"></div>';
					html+='<div>';
					...
					html += '<div class="d-flex justify-content-between removes ">';
						html += '<div class="form-group mb-0 mr-2 w-100">';
							html += '<div class="form-group">';
								...
								html += '</label>';
								html += '<input type="text" class="form-control ans" required="required" id="ans'+index+'">';
							html += '</div>';
						html += '</div>';
						html += '<div class="form-group mb-0 ml-2 removesignans">';
							html += '<label>&nbsp;</label>';
							html += '<button class="btn btn-sm btn-white "><i class="p-0 fa fa-trash text-danger"></i></button>';
						html += '</div>';
					html += '</div>';
	...
	<script src="{{ asset('js/addconFormClienInfo.js') }}"></script>
	<script>
