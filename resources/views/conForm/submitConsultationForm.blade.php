...
<div class="container-fluid p-0">
	<div class="fullscreen-modal" id="consultFormPreview" tabindex="-1" role="dialog" aria-hidden="true">
		...
		<form method="POST" action="{{ route('completeSaveConsultationForm') }}" id="saveConsultationForm">
		@csrf
		...
		<div class="my-custom-header bg-transparent text-dark">
			<div class="p-6 d-flex justify-content-between align-items-center">
				...
				<button class="btn btn-dark px-4 py-2 next-step" type="button" onclick="validateForm(1)">Next Step</button>
			</div>
		</div> 
		<div class="border-0 mb-5 text-center firstStep"> 
			...
			<h1 class="modal-title fw-800 step-main-title">Cilent name</h1>
			...
			<div class="modal-content">  
				<div class="my-custom-body">
					...
					<div class="cform-step">
						<div class="card px-0 py-4 border-0">  
							...
							<div class="form-group">
								...
								<input type="date" class="form-control inputFormData client_birthday" placeholder="dd-M-yyyy" name="client_birthday" id="client_birthday" value="{{ ($ClientConsultationFormGet['client_birthday']) ? date("Y-m-d",strtotime($ClientConsultationFormGet['client_birthday'])) : '' }}" autocomplete="off" data-requiredEle="required" data-elementType="text" data-uniqueClassName="client_birthday">
							</div>
							@endif
							...
							<div class="form-group">
								...
								<select class="form-control select2" name="country_code" id="country_code" style="opacity: 1">
									@if($Country)
						...
						@foreach($ClientConsultationFormField as $ClientConsultationFormFieldData)	
							...
							<div class="cform-step subSteps">
								...
								<div class="border-0 d-block mb-5 text-center"> 
									...
									<h1 class="modal-title fw-800 step-main-title">{{ $ClientConsultationFormFieldData['section_title'] }}</h1>
					...
					<div class="cform-step">
						...
						<div class="border-0 d-block mb-5 text-center"> 
							<h6 class="modal-title text-muted">Consultation form - Step <span>{{ $i }}</span> of {{ $TotalSteps }}</h6> 
							<h1 class="modal-title fw-800 step-main-title">Signatures</h1>
						</div>
						...
						<div class="card px-0 py-4 border-0"> 
							...
							<div class="form-group"> 
								 <div>
									<input id="confirm" class="checkbox-custom inputFormData confirm" name="confirm" type="checkbox" checked data-requiredEle="required" data-elementType="text" data-uniqueClassName="confirm">
