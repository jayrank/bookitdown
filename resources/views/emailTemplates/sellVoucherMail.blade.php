                        ...
                        <tbody>
                              ...
                              <td align="center"
                                 ...
                                 <p style="display:block;font-size:0.88em;line-height:1.4em;color:#ffffff;margin:0">
                                    Voucher Code : <span style="font-weight:bolder">{{
                                       $voucher_sold_data['voucher_code'] }}</span>
                                 </p>
                              </td>
                           </tr>
                           <tr>
                              <td align="center"
                                 ...
                                 valign="middle">
                                 <a href="{{ route('search_detail', $location_info['locationEncrytId']) }}"
                           ...
                           <tr>
                              <td align="center"
                                 ...
                                 valign="middle">
                                 <p style="display:block;font-size:0.88em;line-height:1.4em;color:#ffffff;margin:0">
                                    Redeem on <span class="font-weight-bolder cursor-pointer">{{
                                       $voucher_sold_data['redeem_on'] }}</span> <i
