										...
										<tbody>
											<tr>
												<td colspan="2" style="font-size:28px;padding:24px 0 8px 0;">
													Thank you for visiting {{ $client->firstname }} {{ $client->lastname
													}}
												</td>
												{{-- <span class="mb-3 badge badge-pill badge-success">Completed</span>
												--}}
											</tr>
											{{-- <tr>
												<td colspan="2">
														...
														<tbody>
															...
															<tr>
																<td
																	...
																	@php if($AppointmentServices->duration
																	<=0 ) {echo '00h 00min' ;} else { if(sprintf( "%02d"
											...
											<tr>
												...
												<div class=" d-flex justify-content-between ">
													<div>
														...
														<p class="m-0 shownote" id="desshow">{{ $remider->important_info
															}}</p>
													</div>
												</div>
												@endif
