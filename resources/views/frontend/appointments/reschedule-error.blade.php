	  	...
	  	<div class="modal-dialog">
		    ...
		    <div class="modal-content p-3">
		      	<div class="modal-header border-0">
		        	<h3 class="font-weight-bolder m-0">You can't reschedule this appointment</h3>
		      	...
		      	<div class="modal-body">
					...
					<h6 class="mb-4">This appointment cannot be rescheduled online, because you're trying to reschedule within <b>{{ $beforeHours }}</b> of your appointment time.</h6>
