...
@section('content')
<section class="for-partner my-5">
        <div class="facts aos-init aos-animate">
            <div class="container">
                <div class="row">
                    <div class="col-12 p-4 text-center">
                        <h1 class="font-weight-bolder">World's no.1 destination for beauty and wellness</h1>
                        <h5>ScheduleDown inspires people to look and feel their best – which is why we're trusted by millions
                            of customers and thousands
                            of businesses worldwide</h5>
                    </div>
                </div>
            </div>
    ...
    <section class="for-partner my-5">
        <div class="solution aos-init aos-animate">
            <div class="container">
                <div class="row">
                    <div class="col-12 p-4 text-center">
                        <h1 class="font-weight-bolder">A complete solution to manage and grow your business</h1>
                        <h5>Our powerful suite of tools helps increase sales, manage your schedules and engage with your
                            clients</h5>
                    </div>
                            ...
                            <div class="card-body">
                                <div style="width: 50px;height: 50px">
                                    <svg xmlns="http://www.w3.org/2000/svg" height="50px" viewBox="0 0 512 512"
                                        ...
                                        <path
                                            d="m496 202.667969h-480c-8.832031 0-16-7.167969-16-16s7.167969-16 16-16h480c8.832031 0 16 7.167969 16 16s-7.167969 16-16 16zm0 0">
                                        </path>
                                        <path
                                            d="m122.667969 128c-8.832031 0-16-7.167969-16-16v-96c0-8.832031 7.167969-16 16-16s16 7.167969 16 16v96c0 8.832031-7.167969 16-16 16zm0 0">
                                        </path>
                                        <path
                                            d="m389.332031 128c-8.832031 0-16-7.167969-16-16v-96c0-8.832031 7.167969-16 16-16s16 7.167969 16 16v96c0 8.832031-7.167969 16-16 16zm0 0">
                                        </path>
                                    </svg>
                                </div>
                                <h5 class="font-weight-bolder mt-3 mb-2">Appointment scheduling</h5>
                                <h6 class="text-muted">Professional calendar tools, incredibly easy to use across
                                    mobiles, tablets and
                                    desktops</h6>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="shadow-sm card">
                            <div class="card-body">
                                ...
                                <h5 class="font-weight-bolder mt-3 mb-2">Point of sale (POS)</h5>
                                <h6 class="text-muted">
                                    Everything needed for retail, supporting barcode scanners, receipt printers and cash
                                    drawers
                                </h6>
                            </div>
                        </div>
                                ...
                                <div style="width: 50px;height: 50px">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        ...
                                        <g>
                                            <g>
                                                <path
                                                    d="M511.52,172.128l-32-128C477.76,36.992,471.328,32,464,32H48c-7.328,0-13.76,4.992-15.52,12.128l-32,128    C0.16,173.376,0,174.688,0,176c0,26.816,12.704,50.464,32,64.992V464c0,8.832,7.168,16,16,16h160c8.832,0,16-7.168,16-16V352h64    v112c0,8.832,7.168,16,16,16h160c8.832,0,16-7.168,16-16V240.992c19.296-14.528,32-38.176,32-64.992    C512,174.688,511.84,173.376,511.52,172.128z M448,448H320V336c0-8.832-7.168-16-16-16h-96c-8.832,0-16,7.168-16,16v112H64V254.72    c3.936,0.672,7.904,1.28,12,1.28c24.384,0,46.08-12.128,60-30.944C149.92,243.872,171.616,256,196,256    c24.384,0,46.08-12.128,60-30.944C269.92,243.872,291.616,256,316,256c24.384,0,46.08-12.128,60-30.944    C389.92,243.872,411.616,256,436,256c4.096,0,8.064-0.608,12-1.28V448z M436,224c-24.256,0-44-21.536-44-48    c0-8.832-7.168-16-16-16c-8.832,0-16,7.168-16,16c0,26.464-19.744,48-44,48c-24.256,0-44-21.536-44-48c0-8.832-7.168-16-16-16    c-8.832,0-16,7.168-16,16c0,26.464-19.744,48-44,48s-44-21.536-44-48c0-8.832-7.168-16-16-16c-8.832,0-16,7.168-16,16    c0,26.464-19.744,48-44,48c-23.68,0-43.072-20.544-43.968-46.144L60.512,64H451.52L480,177.856    C479.072,203.456,459.68,224,436,224z">
                                                </path>
                                            </g>
                                        </g>
                                    </svg>
                                </div>
                                <h5 class="font-weight-bolder mt-3 mb-2">Product inventory</h5>
                                <h6 class="text-muted">
                                    Stock management with supplier ordering, professional use tracking, and retail stock
                                </h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="shadow-sm card">
                            <div class="card-body">
                                ...
                                <h5 class="font-weight-bolder mt-3 mb-2">Reporting and analytics</h5>
                                <h6 class="text-muted">
                                    Optimize your business with insights from live performance dashboards and financial
                                    reporting
                                </h6>
                            </div>
                        </div>
                    ...
                    <div class="col-12 col-sm-4">
                        <div class="shadow-sm card">
                            <div class="card-body">
                                ...
                                <h5 class="font-weight-bolder mt-3 mb-2">Marketing promotions</h5>
                                <h6 class="text-muted">
            ...
            <div class="container">
                    ...
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="img-div">
                            <div class="d-flex justify-content-center align-items-center">
                                <img alt="phone" src="{{ asset('frontend/img/iphone mockup') }}.png" width="50%" data-aos="flip-right"
                                    style="box-shadow: 4px 8px 46px -6px #ccc;border-radius: 18px;">
                                <!-- <img alt="phone" class="position-absolute" src="{{ asset('frontend/img/birthday.png') }}" width="100%"> -->
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="content-div py-5">
                            <h4 class="text-primary">ONLINE BOOKING</h4>
                            <h1 class="title mb-4">Grow sales by attracting new clients online</h1>
                            <h6 class="mb-4">
                                Join the world’s largest beauty and wellness network that sends millions of clients to
                                salons and spas every month.
                            </h6>
                            <h6>
                                Free up your time to focus on what you do best, create your online profile and be
                                discovered 24/7 on ScheduleDown marketplace,
                                Instagram, Facebook, Google and your own website
                            </h6>
                            <ul class="indicator">
                                <li>Attract and retain clients</li>
                                <li>Live online self-booking</li>
                                <li>Trusted ratings and reviews</li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="row  my-3 col-sm-reverse">
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="content-div py-5">
                            <h4 class="text-success">PAYMENT PROCESSING</h4>
                            <h1 class="title mb-4">Save costs with low payment processing rates</h1>
                            <h6 class="mb-4">
                                Securely save client cards on file for an effortless checkout experience using our
                                modern, secure payments system</h6>
                            <h6>
                                Take back control of your calendar by remotely charging no-show and late cancellation
                                penalty fees, receive automatic
                                payouts daily to your connected bank account
                            </h6>
                            <ul class="indicator">
                                <li>Very low processing fees</li>
                                <li>Pay-by-app online processing</li>
                    ...
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="img-div">
                            <div class="d-flex justify-content-center align-items-center">
                                <img alt="phone" src="{{ asset('frontend/img/watch.png') }}" width="100%">
                                <!-- <img alt="phone" class="position-absolute" src="{{ asset('frontend/img/swipe.png') }}" width="100%"> -->
                                <img alt="phone" class="position-absolute" src="{{ asset('frontend/img/swipe.png') }}" width="100%" style="width:60%;top: 100px;">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row my-3">
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="img-div">
                            <div class="d-flex justify-content-center align-items-center">
                                <img alt="phone" src="{{ asset('frontend/img/discount.png') }}" width="100%">
                                <img alt="phone" class="position-absolute" src="{{ asset('frontend/img/birthday.png') }}" width="100%">
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-sm-12 col-md-6 p-5">
                        <div class="content-div py-5">
                            <h4 class="text-warning">AUTOMATED MARKETING</h4>
                            <h1 class="title mb-4">Retain clients with smart marketing offers</h1>
                            <h6 class="mb-4">
                                Boost sales and fill your calendar with a suite of intelligent marketing tools to keep
                                clients returning
                            </h6>
                            <h6>
                                Simply set and forget to automatically reach clients through campaigns using targeted,
                                personalized offers for
                                birthdays, lapsing clients, top spenders and many more segments
                            </h6>
                            <ul class="indicator">
                                <li>Customizable message templates</li>
                                <li>Advanced client targeting</li>
                                <li>Personalized per-client offers</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-8 text-center">
                        <ul class="ks-cboxtags">
                            ...
                            <li class="card-body bg-white rounded shadow-sm"><a href="#">
                                    <div class="m-auto" style="width: 50px;height: 50px;">
                            ...
                            <li class="card-body bg-white rounded shadow-sm"><a href="#">
                                    <div class="m-auto" style="width: 50px;height: 50px;">
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64">
                                            <path
                                                d="M36.8 59.4h-8.4c-6.5 0-11.8-4.5-11.8-10.1 0-.5.4-.9.9-.9s.9.4.9.9c0 4.6 4.5 8.3 10 8.3h8.4c5.5 0 10-3.8 10-8.4 0-.5.4-.9.9-.9s.9.4.9.9c0 5.7-5.3 10.2-11.8 10.2zm-19.4-12c-.5 0-.9-.4-.9-.9V21.3c0-3.9 3-7.2 7.4-8.2.5-.1 1 .2 1.1.7.1.5-.2 1-.7 1.1-3.5.8-6 3.4-6 6.4v25.1c0 .6-.4 1-.9 1zm30.3-.1c-.5 0-.9-.4-.9-.9V21.6c0-3-2.3-5.6-5.8-6.6a.8.8 0 01-.6-1.1c.1-.5.6-.8 1.1-.6 4.2 1.2 7.1 4.5 7.1 8.3v24.8c0 .5-.4.9-.9.9z">
                                            </path>
                                            <path
                                                d="M47.1 49.8c-1.1 0-3.3-.6-8.1-3.1-1.8-1-4.9-2.7-6.3-3.7-1.4 1-4.6 2.8-6.3 3.7-7.2 3.8-8.5 3.2-9.1 2.9-1.4-.7-2.1-1.6-1.9-2.6.1-.6.7-1.2 1.8-1.2 2.3 0 3.4-1.1 4.8-3.1 2.1-3.2 4.3-3.9 8.2-4.1.1 0 1.7 0 2.6.2.9-.2 2.5-.2 2.6-.2 3.9.2 6.2.9 8.2 4.1 1.3 2.1 2.4 3.1 4.8 3.1 1.1 0 1.6.6 1.8 1.2.2.9-.5 1.9-1.9 2.6-.5.1-.7.2-1.2.2zm-29.8-2.2c.1.1.3.2.6.4 1.6.6 12.5-5.5 14-6.8.3-.4 1-.4 1.3 0 1.5 1.3 12.4 7.4 14 6.8.3-.1.5-.3.6-.4-3.3-.1-4.8-2-6-4-1.5-2.4-2.9-3.1-6.8-3.3-.3 0-1.8.1-2.1.2-.2.1-.4.1-.6 0-.3-.1-1.9-.2-2.2-.2-3.9.2-5.3.9-6.8 3.3-1.2 2-2.7 3.9-6 4zm31 0zm-31.5 0zm15.8-5.8zm-.4-1.3zm-15 .4H17c-.2-.1-1.3-.1-1.7-.1-.7 0-1.3-.4-1.7-1.3-1.1-2.2-2.1-10.3-1.3-11.3 1.7-2 3.4-.7 4.5.2.3.2.6.5.9.7.4.3.5.8.3 1.2-.3.4-.8.5-1.2.3-.4-.2-.7-.5-1-.8-1.2-1-1.5-1-1.9-.6-.2 1.6.6 8.7 1.6 9.8.6 0 1.7.1 2.1.2.5.1.8.6.7 1.1-.4.3-.7.6-1.1.6zm30.8 0c-.4 0-.8-.3-.9-.7-.1-.5.2-1 .7-1.1.4-.1 1.5-.2 2.1-.2 1-1.1 1.7-8.2 1.6-9.8-.4-.4-.7-.4-1.9.6-.3.3-.7.5-1 .8-.4.3-1 .2-1.2-.3-.3-.4-.2-1 .3-1.2.3-.2.6-.4.9-.7 1.1-.9 2.8-2.2 4.5-.2.7.8 0 8.7-1.3 11.3-.4.9-1 1.4-1.7 1.3-.4 0-1.5.1-1.7.1-.2.1-.3.1-.4.1zM13.7 20.6c-.5 0-.9-.4-.9-.9.2-3.9 2.4-6.2 4.6-8.7 1.4-1.5 3.4-1.6 4.8-1.1s2.4 1.5 2.6 2.5c.1 1.1.1 2.1.1 2.8 0 .8 0 1.7.2 1.8.6.5 4.8-.3 7.5-.9 1.1-.2 2.3-.8 3.5-1.4 1.8-.9 3.6-1.8 5.4-1.5.5.1.8.6.7 1-.1.5-.5.8-1 .7-1.2-.2-2.7.6-4.3 1.4-1.3.6-2.6 1.3-3.9 1.6-6 1.2-7.9 1.4-9 .5-.9-.7-.9-1.8-.9-3.2 0-.8 0-1.6-.1-2.6 0-.3-.5-.8-1.3-1-.4-.1-1.9-.5-2.9.6-2.5 2.7-4 4.5-4.2 7.6 0 .5-.4.8-.9.8z">
                                            </path>
                                            <path
                                                d="M32.3 47.4c-2.7 0-6-.2-6.6-1-.3-.4-.2-1 .3-1.2.4-.2.8-.2 1.1.1 1.3.5 9.7.5 11 0 .3-.3.7-.3 1-.2.4.2.6.8.4 1.2-.3.6-.8.9-3.4 1 0 0-1.7.1-3.8.1zm5.6-1.9zm.3-.3zm4.1-1.6c-.4 0-.8-.3-.9-.7-.1-.3.1-.7.3-.9.6-.7 4.5-6.5 4.8-7.1.2-.4.6-.6 1.1-.5.5.1.7.7.6 1.1 0 .1-4.8 7.8-5.8 8 .1.1 0 .1-.1.1zm-19.8 0h-.2c-.9-.2-5.7-7.9-5.8-8-.1-.5.1-1 .6-1.1.4-.1.9.1 1.1.5.3.6 4.2 6.4 4.8 7.1.2.2.4.5.3.9 0 .3-.4.6-.8.6zm26.4-14.5c-.3 0-.5-.1-.7-.3-.7-.8-.4-2.4 1.4-7.3.2-.5.3-.9.4-1.1l.1-.3c1.5-4.5 1.5-4.5-3-7.6-.1-.1-.7.3-1.1.6-.5.4-1.1.8-1.8 1.1-.3.1-.6.1-.9-.1-.3-.2-.4-.5-.3-.8 0-.3.1-.7.2-1.1.1-.5.3-1.4.3-1.8-5.2-4.6-14.6-5.2-21.3-3.3-4.7 1.3-7.9 3.6-8.7 6.4-1 3.4-1 3.4 1.8 7.5l.2.3c.5.7 1.1 2.5 1.9 6 .1.2.1.4.1.4.1.3 0 .7-.2.9-.3.4-.9.4-1.3 0-.2-.2-.2-.3-.4-.9-.9-3.8-1.4-5-1.6-5.4l-.2-.3c-3-4.3-3.3-4.9-2.1-9 1-3.4 4.7-6.1 10-7.6 7-1.9 17.2-1.6 23.1 3.8.6.5.5 1.4.4 2.4.8-.6 1.9-1.3 3-.6 5.5 3.7 5.5 4.5 3.7 9.7l-.1.3c-.1.3-.2.7-.4 1.2-.4 1.2-1.8 4.8-1.7 5.6.2.4.1.9-.2 1.1-.2.2-.4.2-.6.2zm.7-1.4zm-6.1-17.1z">
                                            </path>
                                        </svg>
                                    </div>
                                    Barbershop
    ...
    <!-- <section class="for-partner py-4">
        <div class="solution aos-init aos-animate">
            <div class="container-fluid">
                <div class="row justify-content-center">
                    <div class="col-12 text-center">
                        <h1 class="font-weight-bolder my-4">Download our mobile apps</h1>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <div class="partner-app">
                            <h1 class="text-light font-weight-bolder">Business app for
                                professionals
                            </h1>
                            <div class="d-flex justify-content-between">
                                <a href="#">
                                    <img width="100%" class="img-fluid p-1" alt="app-store" src="{{ asset('frontend/img/appstore.png') }}" />
                                </a>
                                </a href="#">
                                <img width="50%" class="img-fluid p-1" alt="app-store" src="{{ asset('frontend/img/playmarket.png') }}" />
                                </a>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-6">
                        <div class="customer-app">
                            <h1 class="text-light font-weight-bolder">Booking app for
                                customers
                            </h1>
                            <div class="d-flex justify-content-between">
                                <a href="#">
