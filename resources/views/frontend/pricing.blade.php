        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-12 col-md-6 p-4">
                    ...
                    <ul class="indicator">
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited calendar bookings</span> - super easy to use
                            across mobiles, tablets and desktops
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited team members</span> - invite your team to join
                            your account and stay up-to-date with appointment notifications
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited locations </span>- manage multiple venues from
                            one main account with no limitations
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited clients & notifications</span> - track client
                            history, keep notes and stay in contact with integrated email
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited Point of Sale use</span> - a complete POS
                            solution supporting barcode scanners, receipt printers and cash drawers
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited product inventory</span> - record and track stock
                            inventory with support for supplier ordering
                        </li>
                        <li class="my-3">
                            <span class="font-weight-bolder">Unlimited reporting and much more</span>- everything you
                            need to manage your business in one easy-to-use solution
                        </li>

                    </ul>
                </div>
                <div class="col-12 col-md-6 pt-5 pr-0">
