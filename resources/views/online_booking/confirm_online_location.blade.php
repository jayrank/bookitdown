		...
		<div class="my-custom-body-wrapper">
			<div class="my-custom-header">
				<div class="border-bottom d-flex justify-content-center p-4 text-center">
					<h1 class="font-weight-bolder">Preview And Publish
				...
				<div class="container">
					<div class="row">
						<div class="col-md-4 offset-md-4 text-center py-20">
							...
							<h2 class="font-weight-bolder mb-5">You're almost ready!</h2>
							<h4 class="mb-10">Preview the appearance of your online booking profile before publishing</h4>
							<div class="action-btn d-flex justify-content-center">
								<a href="{{ route('search_detail',['id' => Crypt::encryptString($locationId)]) }}" target="_blank" class="btn btn-lg btn-white mr-4">Preview profile</a>

								<form action="{{ route('confirmOnlineLocationPost') }}" method="post" >
									@csrf
									<input type="hidden" name="location_id" value="{{ $locationId }}">
									<input type="submit" class="btn btn-lg btn-dark" value="Publish Profile Now">
								</form>
							</div>
						</div>
					</div>
