		...
		<div class="d-flex flex-column-fluid">
			...
			<div class="container">
				<div class="content-header" style="margin-top:18px;">
					<div class="align-items-center justify-content-between display-service">
						<div class="">
						...
						<div class="action-btn-div">
							...
							<div class="dropdown dropdown-inline mr-2">
								<button type="button"
									class="btn btn-lg btn-primary my-2 font-weight-bolder my-2"
									data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
									</span>Add New</button>
							...
							<div class="dropdown dropdown-inline">
								...
								<div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
									<ul class="navi navi-hover">
										...
										<li class="navi-item">
											<a href="#" class="navi-link" id="deletecat" data-id="{{ $catvalue->id }}">
	        ...
	        <div class="my-custom-header text-dark"> 
	            <div class="p-5" style="flex-shrink: 0; display: grid; grid-template-columns: 1fr auto 1fr; align-items: center;">
		            ...
		            <div style="display: flex; flex-grow: 1; grid-auto-flow: column; justify-content: flex-end;">
		                <button type="submit" class="btn btn-lg btn-primary px-4 py-2" id="service_submit" name="submitButton">Save</button>
		            </div>
		        </div>
	        </div> 
											...
											<div class="card-body p-0">
												<div class="addpricing_option">
													...
													<div class="w-100 pricing_row pr_rw{{ $i }}">
														...
														<div class="w-100 d-flex price-type-container">	
															...
															<div class="col-md-2 freehd1 ad">
																<div class="form-group">
																	<label class="col-form-label text-right">Price <span class="price-type-text text-muted"></span></label>
																	<input type="text" class="form-control dpr price1 allow_only_decimal" name="price{{ $i }}"  data-optid="1" id="price1" autocomplete="off" placeholder="Price"/>
																</div>	
															</div>
															<div class="col-md-3 freehd1 ad">
																<div class="form-group">
																	<label class="col-form-label text-right">Special price <span class="text-muted">(optional)</span></label>
																	<input type="text" class="form-control dsp allow_only_decimal" name="special_price{{ $i }}" data-optid="1" id="special_price1" autocomplete="off" placeholder="Special price"/>
																</div>	
															</div>
																...
																<div class="modal-content">
																	...
																	<div class="modal-body">
																		<div class="row">
																			...
																			<div class="col-md-2">
																				<div class="form-group">
																					...
																					<input type="text" class="form-control dpr allow_only_decimal" data-optid="1" id="mprice{{ $i }}" autocomplete="off" placeholder="Price"/>
																				</div>	
																			</div>
																			<div class="col-md-3">
																				<div class="form-group">
																					<label class="col-form-label text-right">Special price <span class="text-muted">(optional)</span></label>
																					<input type="text" class="form-control dsp allow_only_decimal" data-optid="1" id="mspecial_price{{ $i }}" autocomplete="off" placeholder="Special price"/>
																				</div>	
																			</div>
																		</div>	
																		...
																		<div class="row">	
																			...
																			<div class="staff-price-container col-md-12 row">
																				<div class="col-md-3">
																					<div class="form-group">
																				...
																				<div class="col-md-2">
																					<div class="form-group">
																						<input type="text" class="form-control spr1 staff-price allow_only_decimal" name="staff_price{{ $s }}[]"  autocomplete="off" placeholder="Price"/>
																					</div>	
																				</div>
																				<div class="col-md-3">
																					<div class="form-group">
																						<input type="text" class="form-control ssp1 staff-special-price allow_only_decimal"  name="staff_special_price{{ $s }}[]" autocomplete="off" placeholder="Special price"/>
																					</div>	
																				</div>
																			</div>
																			@endforeach
