...
<head>
<meta charset="UTF-8">
<title>Sales By Client Report</title>
...
<body>
    <table width="100%">
		<tr>
			<td>
				<h1 style="font-weight: normal; color: #000">Sales By Client Report: {{ date("l, d M Y") }}</h1>
		...
		<thead>
			<tr>
				<th colspan="4" style="text-align:left; padding-top: 16px;">
					<h2 style="font-weight: normal; color: #000">Sales By Client</h2>
				</th>
			</tr>
		</thead>
		<tbody>
