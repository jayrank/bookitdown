														...
														<div class="w-100 d-flex price-type-container">	
															...
															<div class="col-md-2 freehd1 ad">
																<div class="form-group">
																	...
																	<input type="text" class="form-control dpr price1" name="price{{ $i }}"  data-optid="1" id="price1" autocomplete="off" placeholder="Price"/>
																</div>	
															</div>
															<div class="col-md-3 freehd1 ad">
																<div class="form-group">
																	...
																	<input type="text" class="form-control dsp" name="special_price{{ $i }}" data-optid="1" id="special_price1" autocomplete="off" placeholder="Special price"/>
																</div>	
															</div>
																	...
																	<div class="modal-body">
																		<div class="row">
																			...
																			<div class="col-md-2">
																				<div class="form-group">
																					...
																					<input type="text" class="form-control dpr" data-optid="1" id="mprice{{ $i }}" autocomplete="off" placeholder="Price"/>
																				</div>	
																			</div>
																			<div class="col-md-3">
																				<div class="form-group">
																					<label class="col-form-label text-right">Special price <span class="text-muted">(optional)</span></label>
																					<input type="text" class="form-control dsp" data-optid="1" id="mspecial_price{{ $i }}" autocomplete="off" placeholder="Special price"/>
																				</div>	
																			</div>
																		</div>	
																		...
																		<div class="row">	
																			...
																			<div class="staff-price-container col-md-12 row">
																				...
																				<div class="col-md-2">
																					<div class="form-group">
																						<input type="text" class="form-control spr1 staff-price" name="staff_price{{ $s }}[]"  autocomplete="off" placeholder="Price"/>
																					</div>	
																				</div>
																				<div class="col-md-3">
																					<div class="form-group">
																						<input type="text" class="form-control ssp1 staff-special-price"  name="staff_special_price{{ $s }}[]" autocomplete="off" placeholder="Special price"/>
																					</div>	
																				</div>
																			</div>
																			@endforeach
