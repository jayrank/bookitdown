...
@section('content')
	<!-- <div class="container-fluid p-0">
		<form class="form" method="POST" id="addpaidplan" action="{{ route('savePlans') }}">
			@csrf
			<div class="my-custom-body-wrapper">
				<div class="my-custom-header">
					<div class="p-4 d-flex justify-content-between align-items-center border-bottom">
						...
						<h1 class="font-weight-bolder">Create a paid plan</h1>
						<button type="button" class="btn btn-primary" id="save">Create a paid plan</button>
					</div>
				</div>
								...
								<div class="card my-4">
									...
									<div class="card-body w-70">
										<div class="form-group mr-2 w-100">
											...
											<input type="text" name="name" class="form-control" placeholder="Add paid plan name">
										</div>
										...
										<div class="d-flex justify-content-between">
											<div class="form-group mr-2 w-100">
												...
												<select class="form-control" id="select-session" name="sessions">
													<option value="0" selected="">Limited</option>
													<option value="1">Unlimited</option>
												</select>
											</div>
											<div class="form-group ml-2 w-100">
												<label class="font-weight-bolder">Total number of sessions</label>
												<input type="text" class="form-control" placeholder="5" name="sessions_num">
											</div>
										</div>
									</div>
								</div>
										...
										<div class="form-group">
											<div class="mt-4 switch switch-icon switch-primary" style="line-height: 33px;">
												<label class="d-flex align-item-center font-weight-bolder">
													<input type="checkbox" checked="checked" name="online_sales" >
												...
												<ul>
													...
													<li>
														<label for="all-{{ $value->category_title }}-{{ $i }}" class="checkbox">
															<input type="checkbox" name="value_checkbox[]" value="{{ $service->id }}" id="all-{{ $value->category_title }}-{{ $i }}">
															<span></span>
	...
	<!--begin::Add Single Service Modal -->
		...
		<form class="form" method="POST" id="addpaidplan" action="{{ route('savePlans') }}">
	        ...
	        <div class="my-custom-header text-dark"> 
	            <div class="p-5" style="flex-shrink: 0; display: grid; grid-template-columns: 1fr auto 1fr; align-items: center;">
		            ...
		            <div style="flex-grow: 1;"><h2 class="font-weight-bolder title-hide">Create a paid plan</h2></div>
		            <div style="display: flex; flex-grow: 1; grid-auto-flow: column; justify-content: flex-end;">
		                <button type="submit" class="btn btn-primary" id="save">Create a paid plan</button>
		            </div>
		        </div>
	        </div>  
            <h1 class="font-weight-bolder mb-5 text-center text-dark hide-onscroll" style="flex-grow: 1;">Create a paid plan</h1>  
            <div class="modal-content">  
								...
								<div class="card my-4">
									...
									<div class="card-body w-70">
										...
										<div class="d-flex justify-content-between">
											...
											<div class="form-group ml-2 w-100 no_of_session">
												<label class="font-weight-bolder">Total number of sessions</label>
												<input type="text" class="form-control" placeholder="5" name="sessions_num">
											</div>
										</div>
