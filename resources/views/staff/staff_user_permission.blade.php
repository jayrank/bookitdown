													...
													<table class="table table-bordered">
														...
														<tbody>
															...
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="38" class="form-control text-center" @if(in_array(38, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="38" class="form-control text-center" @if(in_array(38, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="38" class="form-control text-center" @if(in_array(38, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="38" class="form-control text-center" @if(in_array(38, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="39" class="form-control text-center" @if(in_array(39, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="39" class="form-control text-center" @if(in_array(39, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="39" class="form-control text-center" @if(in_array(39, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="39" class="form-control text-center" @if(in_array(39, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="40" class="form-control text-center" @if(in_array(40, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="40" class="form-control text-center" @if(in_array(40, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="40" class="form-control text-center" @if(in_array(40, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="40" class="form-control text-center" @if(in_array(40, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
													...
													<table class="table table-bordered">
														...
														<tbody>
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="43" class="form-control text-center" @if(in_array(43, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="43" class="form-control text-center" @if(in_array(43, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="43" class="form-control text-center" @if(in_array(43, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="43" class="form-control text-center" @if(in_array(43, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="44" class="form-control text-center" @if(in_array(44, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="44" class="form-control text-center" @if(in_array(44, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="44" class="form-control text-center" @if(in_array(44, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="44" class="form-control text-center" @if(in_array(44, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
															...
															<tr>
																...
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="basic_permission[]" value="45" class="form-control text-center" @if(in_array(45, $basicPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="low_permission[]" value="45" class="form-control text-center" @if(in_array(45, $lowPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="medium_permission[]" value="45" class="form-control text-center" @if(in_array(45, $mediumPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
																<td>
																	<label class="checkbox flex-center">
																		<input type="checkbox" name="high_permission[]" value="45" class="form-control text-center" @if(in_array(45, $highPermission) && $is_scheduledown_pro == 1) checked @else disabled="disabled" @endif>
																		<span></span>
																	</label>
																</td>
															</tr>
